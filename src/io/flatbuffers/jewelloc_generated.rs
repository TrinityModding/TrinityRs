...
impl Unk0T {
    pub fn pack<'b>(
        ...
        let unk0 = self.unk0;
        let unk1 = self.unk1;
        Unk0::create(_fbb, &Unk0Args { unk0, unk1 })
    }
}
pub enum Unk1Offset {}
#[derive(Copy, Clone, PartialEq)]
...
impl Unk1T {
    pub fn pack<'b>(
        ...
        let res0 = self.res0;
        Unk1::create(_fbb, &Unk1Args { res0 })
    }
}
...
impl PositionT {
    pub fn pack<'b>(
        ...
        let y = self.y;
        let z = self.z;
        Position::create(_fbb, &PositionArgs { x, y, z })
    }
}
...
impl<'a> JewelLoc<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        if let Some(x) = args.unk1 {
            builder.add_unk1(x);
        }
        if let Some(x) = args.unk0 {
            builder.add_unk0(x);
        }
    ...
    pub fn unpack(&self) -> JewelLocT {
        ...
        let unk0 = self.unk0().map(|x| Box::new(x.unpack()));
        let unk1 = self.unk1().map(|x| Box::new(x.unpack()));
    ...
    pub fn name(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(JewelLoc::VT_NAME, None)
        }
    }
    #[inline]
    pub fn unk0(&self) -> Option<Unk0<'a>> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<Unk0>>(JewelLoc::VT_UNK0, None)
        }
    }
    #[inline]
    pub fn unk1(&self) -> Option<Unk1<'a>> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<Unk1>>(JewelLoc::VT_UNK1, None)
        }
    }
    #[inline]
    pub fn position(&self) -> Option<Position<'a>> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<Position>>(JewelLoc::VT_POSITION, None)
        }
    }
}
...
impl<'a: 'b, 'b> JewelLocBuilder<'a, 'b> {
    ...
    pub fn add_name(&mut self, name: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(JewelLoc::VT_NAME, name);
    }
    #[inline]
    pub fn add_unk0(&mut self, unk0: flatbuffers::WIPOffset<Unk0<'b>>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<Unk0>>(JewelLoc::VT_UNK0, unk0);
    }
    #[inline]
    pub fn add_unk1(&mut self, unk1: flatbuffers::WIPOffset<Unk1<'b>>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<Unk1>>(JewelLoc::VT_UNK1, unk1);
    }
    #[inline]
    pub fn add_position(&mut self, position: flatbuffers::WIPOffset<Position<'b>>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<Position>>(JewelLoc::VT_POSITION, position);
    }
    #[inline]
...
impl JewelLocT {
    pub fn pack<'b>(
        ...
        let unk0 = self.unk0.as_ref().map(|x| x.pack(_fbb));
        let unk1 = self.unk1.as_ref().map(|x| x.pack(_fbb));
...
impl<'a> JewelLocs<'a> {
    ...
    pub fn unpack(&self) -> JewelLocsT {
        let list = self.list().map(|x| x.iter().map(|t| t.unpack()).collect());
        JewelLocsT { list }
    }
    ...
    pub fn list(
        &self,
    ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<JewelLoc<'a>>>> {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab.get::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<JewelLoc>>,
            >>(JewelLocs::VT_LIST, None)
        }
    }
}
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            .visit_field::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<JewelLoc>>,
...
pub struct JewelLocsArgs<'a> {
    pub list: Option<
        flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<JewelLoc<'a>>>>,
    >,
}
impl<'a> Default for JewelLocsArgs<'a> {
    #[inline]
    fn default() -> Self {
        JewelLocsArgs { list: None }
    }
}
...
impl<'a: 'b, 'b> JewelLocsBuilder<'a, 'b> {
    ...
    pub fn add_list(
        ...
        list: flatbuffers::WIPOffset<
            flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<JewelLoc<'b>>>,
        >,
    ) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(JewelLocs::VT_LIST, list);
    }
    #[inline]
...
impl JewelLocsT {
    pub fn pack<'b>(
        ...
        JewelLocs::create(_fbb, &JewelLocsArgs { list })
    }
}
#[inline]
...
pub fn size_prefixed_root_as_jewel_locs(
    buf: &[u8],
) -> Result<JewelLocs, flatbuffers::InvalidFlatbuffer> {
...
#[inline]
pub fn finish_size_prefixed_jewel_locs_buffer<'a, 'b>(
    fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
    root: flatbuffers::WIPOffset<JewelLocs<'a>>,
) {
