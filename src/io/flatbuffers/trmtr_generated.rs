    ...
    pub mod model {
        ...
        impl UVWrapMode {
            ...
            pub const ENUM_VALUES: &'static [Self] =
                &[Self::WRAP, Self::CLAMP, Self::MIRROR, Self::MIRROR_ONCE];
        ...
        impl<'b> flatbuffers::Push for RGBA {
            ...
            unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
                let src =
                    ::core::slice::from_raw_parts(self as *const RGBA as *const u8, Self::size());
        ...
        impl<'a> SamplerState<'a> {
            ...
            pub fn unpack(&self) -> SamplerStateT {
                ...
                let border_color = self.border_color().map(|x| x.unpack());
                SamplerStateT {
                    SamplerState_0,
                    SamplerState_1,
                    SamplerState_2,
            ...
            pub fn SamplerState_0(&self) -> u32 {
                ...
                unsafe {
                    self._tab
                        .get::<u32>(SamplerState::VT_SAMPLERSTATE_0, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn SamplerState_1(&self) -> u32 {
                ...
                unsafe {
                    self._tab
                        .get::<u32>(SamplerState::VT_SAMPLERSTATE_1, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn SamplerState_2(&self) -> u32 {
                ...
                unsafe {
                    self._tab
                        .get::<u32>(SamplerState::VT_SAMPLERSTATE_2, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn SamplerState_3(&self) -> u32 {
                ...
                unsafe {
                    self._tab
                        .get::<u32>(SamplerState::VT_SAMPLERSTATE_3, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn SamplerState_4(&self) -> u32 {
                ...
                unsafe {
                    self._tab
                        .get::<u32>(SamplerState::VT_SAMPLERSTATE_4, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn SamplerState_5(&self) -> u32 {
                ...
                unsafe {
                    self._tab
                        .get::<u32>(SamplerState::VT_SAMPLERSTATE_5, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn SamplerState_6(&self) -> u32 {
                ...
                unsafe {
                    self._tab
                        .get::<u32>(SamplerState::VT_SAMPLERSTATE_6, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn SamplerState_7(&self) -> u32 {
                ...
                unsafe {
                    self._tab
                        .get::<u32>(SamplerState::VT_SAMPLERSTATE_7, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn SamplerState_8(&self) -> u32 {
                ...
                unsafe {
                    self._tab
                        .get::<u32>(SamplerState::VT_SAMPLERSTATE_8, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn repeat_u(&self) -> UVWrapMode {
                ...
                unsafe {
                    self._tab
                        .get::<UVWrapMode>(SamplerState::VT_REPEAT_U, Some(UVWrapMode::WRAP))
                        .unwrap()
                }
            }
            #[inline]
            pub fn repeat_v(&self) -> UVWrapMode {
                ...
                unsafe {
                    self._tab
                        .get::<UVWrapMode>(SamplerState::VT_REPEAT_V, Some(UVWrapMode::WRAP))
                        .unwrap()
                }
            }
            #[inline]
            pub fn repeat_w(&self) -> UVWrapMode {
                ...
                unsafe {
                    self._tab
                        .get::<UVWrapMode>(SamplerState::VT_REPEAT_W, Some(UVWrapMode::WRAP))
                        .unwrap()
                }
            }
            #[inline]
        ...
        impl<'a: 'b, 'b> SamplerStateBuilder<'a, 'b> {
            ...
            pub fn add_SamplerState_0(&mut self, SamplerState_0: u32) {
                self.fbb_
                    .push_slot::<u32>(SamplerState::VT_SAMPLERSTATE_0, SamplerState_0, 0);
            }
            #[inline]
            pub fn add_SamplerState_1(&mut self, SamplerState_1: u32) {
                self.fbb_
                    .push_slot::<u32>(SamplerState::VT_SAMPLERSTATE_1, SamplerState_1, 0);
            }
            #[inline]
            pub fn add_SamplerState_2(&mut self, SamplerState_2: u32) {
                self.fbb_
                    .push_slot::<u32>(SamplerState::VT_SAMPLERSTATE_2, SamplerState_2, 0);
            }
            #[inline]
            pub fn add_SamplerState_3(&mut self, SamplerState_3: u32) {
                self.fbb_
                    .push_slot::<u32>(SamplerState::VT_SAMPLERSTATE_3, SamplerState_3, 0);
            }
            #[inline]
            pub fn add_SamplerState_4(&mut self, SamplerState_4: u32) {
                self.fbb_
                    .push_slot::<u32>(SamplerState::VT_SAMPLERSTATE_4, SamplerState_4, 0);
            }
            #[inline]
            pub fn add_SamplerState_5(&mut self, SamplerState_5: u32) {
                self.fbb_
                    .push_slot::<u32>(SamplerState::VT_SAMPLERSTATE_5, SamplerState_5, 0);
            }
            #[inline]
            pub fn add_SamplerState_6(&mut self, SamplerState_6: u32) {
                self.fbb_
                    .push_slot::<u32>(SamplerState::VT_SAMPLERSTATE_6, SamplerState_6, 0);
            }
            #[inline]
            pub fn add_SamplerState_7(&mut self, SamplerState_7: u32) {
                self.fbb_
                    .push_slot::<u32>(SamplerState::VT_SAMPLERSTATE_7, SamplerState_7, 0);
            }
            #[inline]
            pub fn add_SamplerState_8(&mut self, SamplerState_8: u32) {
                self.fbb_
                    .push_slot::<u32>(SamplerState::VT_SAMPLERSTATE_8, SamplerState_8, 0);
            }
            #[inline]
            pub fn add_repeat_u(&mut self, repeat_u: UVWrapMode) {
                self.fbb_.push_slot::<UVWrapMode>(
                    SamplerState::VT_REPEAT_U,
                    repeat_u,
                    UVWrapMode::WRAP,
                );
            }
            ...
            pub fn add_border_color(&mut self, border_color: &RGBA) {
                self.fbb_
                    .push_slot_always::<&RGBA>(SamplerState::VT_BORDER_COLOR, border_color);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
            ) -> SamplerStateBuilder<'a, 'b> {
        ...
        impl<'a> Float4Parameter<'a> {
            ...
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                ...
                if let Some(x) = args.color_value {
                    builder.add_color_value(x);
                }
                if let Some(x) = args.color_name {
                    builder.add_color_name(x);
                }
                builder.finish()
            }

            pub fn unpack(&self) -> Float4ParameterT {
                let color_name = self.color_name().map(|x| x.to_string());
                let color_value = self.color_value().map(|x| x.unpack());
                Float4ParameterT {
                    color_name,
                    color_value,
                }
        ...
        impl<'a: 'b, 'b> Float4ParameterBuilder<'a, 'b> {
            ...
            pub fn add_color_value(&mut self, color_value: &RGBA) {
                self.fbb_
                    .push_slot_always::<&RGBA>(Float4Parameter::VT_COLOR_VALUE, color_value);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
            ) -> Float4ParameterBuilder<'a, 'b> {
                let start = _fbb.start_table();
        ...
        impl<'a> FloatParameter<'a> {
            ...
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                ...
                if let Some(x) = args.float_name {
                    builder.add_float_name(x);
                }
                builder.finish()
            }

            pub fn unpack(&self) -> FloatParameterT {
                let float_name = self.float_name().map(|x| x.to_string());
            ...
            pub fn float_value(&self) -> f32 {
                ...
                unsafe {
                    self._tab
                        .get::<f32>(FloatParameter::VT_FLOAT_VALUE, Some(0.0))
                        .unwrap()
                }
            }
        }
        ...
        impl<'a: 'b, 'b> FloatParameterBuilder<'a, 'b> {
            ...
            pub fn add_float_value(&mut self, float_value: f32) {
                self.fbb_
                    .push_slot::<f32>(FloatParameter::VT_FLOAT_VALUE, float_value, 0.0);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
            ) -> FloatParameterBuilder<'a, 'b> {
                let start = _fbb.start_table();
        ...
        impl FloatParameterT {
            pub fn pack<'b>(
                ...
                let float_name = self.float_name.as_ref().map(|x| _fbb.create_string(x));
                let float_value = self.float_value;
                FloatParameter::create(
                    _fbb,
                    &FloatParameterArgs {
                        float_name,
                        float_value,
        ...
        impl<'a> IntParameter<'a> {
            ...
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                ...
                if let Some(x) = args.int_name {
                    builder.add_int_name(x);
                }
                builder.finish()
            }

            pub fn unpack(&self) -> IntParameterT {
                let int_name = self.int_name().map(|x| x.to_string());
            ...
            pub fn int_name(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<flatbuffers::ForwardsUOffset<&str>>(IntParameter::VT_INT_NAME, None)
                }
            }
            #[inline]
            pub fn int_value(&self) -> i32 {
                ...
                unsafe {
                    self._tab
                        .get::<i32>(IntParameter::VT_INT_VALUE, Some(-1))
                        .unwrap()
                }
            }
        }
        ...
        impl<'a: 'b, 'b> IntParameterBuilder<'a, 'b> {
            ...
            pub fn add_int_value(&mut self, int_value: i32) {
                self.fbb_
                    .push_slot::<i32>(IntParameter::VT_INT_VALUE, int_value, -1);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
            ) -> IntParameterBuilder<'a, 'b> {
                let start = _fbb.start_table();
                IntParameterBuilder {
                    fbb_: _fbb,
                    start_: start,
        ...
        impl IntParameterT {
            pub fn pack<'b>(
                ...
                let int_name = self.int_name.as_ref().map(|x| _fbb.create_string(x));
                let int_value = self.int_value;
                IntParameter::create(
                    _fbb,
                    &IntParameterArgs {
        ...
        impl<'a> StringParameter<'a> {
            ...
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                ...
                if let Some(x) = args.string_name {
                    builder.add_string_name(x);
                }
                builder.finish()
            }

            pub fn unpack(&self) -> StringParameterT {
                let string_name = self.string_name().map(|x| x.to_string());
                let string_value = self.string_value().map(|x| x.to_string());
                StringParameterT {
                    string_name,
                    string_value,
                }
            ...
            pub fn string_name(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                        StringParameter::VT_STRING_NAME,
                        None,
                    )
                }
            }
            ...
            pub fn string_value(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                        StringParameter::VT_STRING_VALUE,
                        None,
                    )
                }
            }
        ...
        impl StringParameterT {
            pub fn pack<'b>(
                ...
                let string_name = self.string_name.as_ref().map(|x| _fbb.create_string(x));
                let string_value = self.string_value.as_ref().map(|x| _fbb.create_string(x));
                StringParameter::create(
                    _fbb,
                    &StringParameterArgs {
                        string_name,
                        string_value,
        ...
        impl<'a> Shader<'a> {
            ...
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                ...
                if let Some(x) = args.shader_values {
                    builder.add_shader_values(x);
                }
                if let Some(x) = args.shader_name {
                    builder.add_shader_name(x);
                }
                builder.finish()
            }

            pub fn unpack(&self) -> ShaderT {
                let shader_name = self.shader_name().map(|x| x.to_string());
                let shader_values = self
                    .shader_values()
            ...
            pub fn shader_name(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<flatbuffers::ForwardsUOffset<&str>>(Shader::VT_SHADER_NAME, None)
                }
            }
            #[inline]
            pub fn shader_values(
                &self,
            ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<StringParameter<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<StringParameter>>,
                    >>(Shader::VT_SHADER_VALUES, None)
                }
            }
        }
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    ...
                    .visit_field::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<StringParameter>>,
                    >>("shader_values", Self::VT_SHADER_VALUES, false)?
                    .finish();
                Ok(())
            }
        }
        pub struct ShaderArgs<'a> {
            ...
            pub shader_values: Option<
                flatbuffers::WIPOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<StringParameter<'a>>>,
                >,
            >,
        }
        ...
        impl<'a: 'b, 'b> ShaderBuilder<'a, 'b> {
            ...
            pub fn add_shader_name(&mut self, shader_name: flatbuffers::WIPOffset<&'b str>) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                    Shader::VT_SHADER_NAME,
                    shader_name,
                );
            }
            #[inline]
            pub fn add_shader_values(
                &mut self,
                shader_values: flatbuffers::WIPOffset<
                    flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<StringParameter<'b>>>,
                >,
            ) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                    Shader::VT_SHADER_VALUES,
                    shader_values,
                );
            }
            #[inline]
        ...
        impl ShaderT {
            pub fn pack<'b>(
                ...
                let shader_name = self.shader_name.as_ref().map(|x| _fbb.create_string(x));
        ...
        impl<'a> Texture<'a> {
            ...
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                ...
                if let Some(x) = args.texture_file {
                    builder.add_texture_file(x);
                }
                if let Some(x) = args.texture_name {
                    builder.add_texture_name(x);
                }
                builder.finish()
            }

            pub fn unpack(&self) -> TextureT {
                let texture_name = self.texture_name().map(|x| x.to_string());
                let texture_file = self.texture_file().map(|x| x.to_string());
            ...
            pub fn texture_name(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<flatbuffers::ForwardsUOffset<&str>>(Texture::VT_TEXTURE_NAME, None)
                }
            }
            #[inline]
            pub fn texture_file(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<flatbuffers::ForwardsUOffset<&str>>(Texture::VT_TEXTURE_FILE, None)
                }
            }
            #[inline]
            pub fn texture_slot(&self) -> u32 {
                ...
                unsafe {
                    self._tab
                        .get::<u32>(Texture::VT_TEXTURE_SLOT, Some(0))
                        .unwrap()
                }
            }
        }
        ...
        impl flatbuffers::Verifiable for Texture<'_> {
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                        "texture_name",
                        Self::VT_TEXTURE_NAME,
                        false,
                    )?
                    .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                        "texture_file",
                        Self::VT_TEXTURE_FILE,
                        false,
                    )?
        ...
        impl<'a: 'b, 'b> TextureBuilder<'a, 'b> {
            ...
            pub fn add_texture_slot(&mut self, texture_slot: u32) {
                self.fbb_
                    .push_slot::<u32>(Texture::VT_TEXTURE_SLOT, texture_slot, 0);
            }
            #[inline]
        ...
        impl TextureT {
            pub fn pack<'b>(
                ...
                let texture_name = self.texture_name.as_ref().map(|x| _fbb.create_string(x));
                let texture_file = self.texture_file.as_ref().map(|x| _fbb.create_string(x));
                let texture_slot = self.texture_slot;
                Texture::create(
                    _fbb,
                    &TextureArgs {
        ...
        impl Byte_ExtraT {
            pub fn pack<'b>(
                ...
                let value = self.value;
                Byte_Extra::create(_fbb, &Byte_ExtraArgs { value })
            }
        }
        ...
        impl Int_ExtraT {
            pub fn pack<'b>(
                ...
                let res_0 = self.res_0;
                let value = self.value;
                Int_Extra::create(_fbb, &Int_ExtraArgs { res_0, value })
            }
        }
        ...
        impl<'a> Material<'a> {
            ...
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                ...
                if let Some(x) = args.alpha_type {
                    builder.add_alpha_type(x);
                }
                if let Some(x) = args.int_extra {
                    builder.add_int_extra(x);
                }
                if let Some(x) = args.byte_extra {
                    builder.add_byte_extra(x);
                }
                if let Some(x) = args.unk_12 {
                    builder.add_unk_12(x);
                }
                if let Some(x) = args.unk_11 {
                    builder.add_unk_11(x);
                }
                if let Some(x) = args.unk_10 {
                    builder.add_unk_10(x);
                }
                if let Some(x) = args.int_parameter {
                    builder.add_int_parameter(x);
                }
                if let Some(x) = args.unk_8 {
                    builder.add_unk_8(x);
                }
                if let Some(x) = args.float4_parameter {
                    builder.add_float4_parameter(x);
                }
                if let Some(x) = args.float4_light_parameter {
                    builder.add_float4_light_parameter(x);
                }
                if let Some(x) = args.unk_5 {
                    builder.add_unk_5(x);
                }
                if let Some(x) = args.float_parameter {
                    builder.add_float_parameter(x);
                }
                if let Some(x) = args.samplers {
                    builder.add_samplers(x);
                }
            ...
            pub fn unpack(&self) -> MaterialT {
                ...
                let samplers = self
                    .samplers()
                    .map(|x| x.iter().map(|t| t.unpack()).collect());
                let float_parameter = self
                    .float_parameter()
                    .map(|x| x.iter().map(|t| t.unpack()).collect());
                let unk_5 = self.unk_5().map(|x| x.to_string());
                let float4_light_parameter = self
                    .float4_light_parameter()
                    .map(|x| x.iter().map(|t| t.unpack()).collect());
                let float4_parameter = self
                    .float4_parameter()
                    .map(|x| x.iter().map(|t| t.unpack()).collect());
                let unk_8 = self.unk_8().map(|x| x.to_string());
                let int_parameter = self
                    .int_parameter()
                    .map(|x| x.iter().map(|t| t.unpack()).collect());
                let unk_10 = self.unk_10().map(|x| x.to_string());
                let unk_11 = self.unk_11().map(|x| x.to_string());
                let unk_12 = self.unk_12().map(|x| x.to_string());
                let byte_extra = self.byte_extra().map(|x| Box::new(x.unpack()));
                let int_extra = self.int_extra().map(|x| Box::new(x.unpack()));
                let alpha_type = self.alpha_type().map(|x| x.to_string());
                MaterialT {
                    name,
                    shaders,
                    textures,
            ...
            ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Shader<'a>>>>
            {
                ...
                unsafe {
                    self._tab.get::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Shader>>,
                    >>(Material::VT_SHADERS, None)
                }
            }
            #[inline]
            pub fn textures(
            ...
            ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Texture<'a>>>>
            {
                ...
                unsafe {
                    ...
                    >>(Material::VT_TEXTURES, None)
                }
            }
            #[inline]
            pub fn samplers(
                &self,
            ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<SamplerState<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<SamplerState>>,
                    >>(Material::VT_SAMPLERS, None)
                }
            }
            #[inline]
            pub fn float_parameter(
                &self,
            ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<FloatParameter<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<FloatParameter>>,
                    >>(Material::VT_FLOAT_PARAMETER, None)
                }
            }
            #[inline]
            pub fn unk_5(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<flatbuffers::ForwardsUOffset<&str>>(Material::VT_UNK_5, None)
                }
            }
            #[inline]
            pub fn float4_light_parameter(
                &self,
            ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Float4Parameter<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Float4Parameter>>,
                    >>(Material::VT_FLOAT4_LIGHT_PARAMETER, None)
                }
            }
            #[inline]
            pub fn float4_parameter(
                &self,
            ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Float4Parameter<'a>>>>
            {
                // Safety:
                ...
                unsafe {
                    self._tab.get::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Float4Parameter>>,
                    >>(Material::VT_FLOAT4_PARAMETER, None)
                }
            }
            #[inline]
            pub fn unk_8(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<flatbuffers::ForwardsUOffset<&str>>(Material::VT_UNK_8, None)
                }
            }
            #[inline]
            pub fn int_parameter(
                &self,
            ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<IntParameter<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<IntParameter>>,
                    >>(Material::VT_INT_PARAMETER, None)
                }
            }
            #[inline]
            pub fn unk_10(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<flatbuffers::ForwardsUOffset<&str>>(Material::VT_UNK_10, None)
                }
            }
            #[inline]
            pub fn unk_11(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<flatbuffers::ForwardsUOffset<&str>>(Material::VT_UNK_11, None)
                }
            }
            #[inline]
            pub fn unk_12(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<flatbuffers::ForwardsUOffset<&str>>(Material::VT_UNK_12, None)
                }
            }
            #[inline]
            pub fn byte_extra(&self) -> Option<Byte_Extra<'a>> {
                ...
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<flatbuffers::ForwardsUOffset<Byte_Extra>>(
                        Material::VT_BYTE_EXTRA,
                        None,
                    )
                }
            }
            ...
            pub fn int_extra(&self) -> Option<Int_Extra<'a>> {
                ...
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<flatbuffers::ForwardsUOffset<Int_Extra>>(
                        Material::VT_INT_EXTRA,
                        None,
                    )
                }
            }
            ...
            pub fn alpha_type(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<flatbuffers::ForwardsUOffset<&str>>(Material::VT_ALPHA_TYPE, None)
                }
            }
        }
        ...
        impl flatbuffers::Verifiable for Material<'_> {
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    ...
                    .visit_field::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Shader>>,
                    >>("shaders", Self::VT_SHADERS, false)?
                    .visit_field::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Texture>>,
                    >>("textures", Self::VT_TEXTURES, false)?
                    .visit_field::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<SamplerState>>,
                    >>("samplers", Self::VT_SAMPLERS, false)?
                    .visit_field::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<FloatParameter>>,
                    >>("float_parameter", Self::VT_FLOAT_PARAMETER, false)?
                    .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                        "unk_5",
                        Self::VT_UNK_5,
                        false,
                    ...
                    .visit_field::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Float4Parameter>>,
                    >>(
                        "float4_light_parameter",
                        Self::VT_FLOAT4_LIGHT_PARAMETER,
                        false,
                    )?
                    .visit_field::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Float4Parameter>>,
                    >>("float4_parameter", Self::VT_FLOAT4_PARAMETER, false)?
                    .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                        "unk_8",
                        Self::VT_UNK_8,
                        false,
                    ...
                    .visit_field::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<IntParameter>>,
                    >>("int_parameter", Self::VT_INT_PARAMETER, false)?
                    .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                        "unk_10",
                        Self::VT_UNK_10,
                        false,
                    ...
                    .visit_field::<flatbuffers::ForwardsUOffset<Byte_Extra>>(
                        "byte_extra",
                        Self::VT_BYTE_EXTRA,
                        false,
                    )?
                    .visit_field::<flatbuffers::ForwardsUOffset<Int_Extra>>(
                        "int_extra",
                        Self::VT_INT_EXTRA,
                        false,
                    )?
        ...
        pub struct MaterialArgs<'a> {
            ...
            pub samplers: Option<
                flatbuffers::WIPOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<SamplerState<'a>>>,
                >,
            >,
            pub float_parameter: Option<
                flatbuffers::WIPOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<FloatParameter<'a>>>,
                >,
            >,
            pub unk_5: Option<flatbuffers::WIPOffset<&'a str>>,
            pub float4_light_parameter: Option<
                flatbuffers::WIPOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Float4Parameter<'a>>>,
                >,
            >,
            pub float4_parameter: Option<
                flatbuffers::WIPOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Float4Parameter<'a>>>,
                >,
            >,
            pub unk_8: Option<flatbuffers::WIPOffset<&'a str>>,
            pub int_parameter: Option<
                flatbuffers::WIPOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<IntParameter<'a>>>,
                >,
            >,
        ...
        impl<'a: 'b, 'b> MaterialBuilder<'a, 'b> {
            ...
            pub fn add_shaders(
                ...
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<_>>(Material::VT_SHADERS, shaders);
            }
            #[inline]
            pub fn add_textures(
                &mut self,
                ...
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<_>>(Material::VT_TEXTURES, textures);
            }
            #[inline]
            pub fn add_samplers(
                &mut self,
                samplers: flatbuffers::WIPOffset<
                    flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<SamplerState<'b>>>,
                >,
            ) {
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<_>>(Material::VT_SAMPLERS, samplers);
            }
            #[inline]
            pub fn add_float_parameter(
                &mut self,
                float_parameter: flatbuffers::WIPOffset<
                    flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<FloatParameter<'b>>>,
                >,
            ) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                    Material::VT_FLOAT_PARAMETER,
                    float_parameter,
                );
            }
            #[inline]
            pub fn add_unk_5(&mut self, unk_5: flatbuffers::WIPOffset<&'b str>) {
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<_>>(Material::VT_UNK_5, unk_5);
            }
            #[inline]
            pub fn add_float4_light_parameter(
                &mut self,
                float4_light_parameter: flatbuffers::WIPOffset<
                    flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<Float4Parameter<'b>>>,
                >,
            ) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                    Material::VT_FLOAT4_LIGHT_PARAMETER,
                    float4_light_parameter,
                );
            }
            #[inline]
            pub fn add_float4_parameter(
                &mut self,
                float4_parameter: flatbuffers::WIPOffset<
                    flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<Float4Parameter<'b>>>,
                >,
            ) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                    Material::VT_FLOAT4_PARAMETER,
                    float4_parameter,
                );
            }
            #[inline]
            pub fn add_unk_8(&mut self, unk_8: flatbuffers::WIPOffset<&'b str>) {
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<_>>(Material::VT_UNK_8, unk_8);
            }
            #[inline]
            pub fn add_int_parameter(
                &mut self,
                int_parameter: flatbuffers::WIPOffset<
                    flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<IntParameter<'b>>>,
                >,
            ) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                    Material::VT_INT_PARAMETER,
                    int_parameter,
                );
            }
            #[inline]
            pub fn add_unk_10(&mut self, unk_10: flatbuffers::WIPOffset<&'b str>) {
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<_>>(Material::VT_UNK_10, unk_10);
            }
            #[inline]
            pub fn add_unk_11(&mut self, unk_11: flatbuffers::WIPOffset<&'b str>) {
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<_>>(Material::VT_UNK_11, unk_11);
            }
            #[inline]
            pub fn add_unk_12(&mut self, unk_12: flatbuffers::WIPOffset<&'b str>) {
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<_>>(Material::VT_UNK_12, unk_12);
            }
            #[inline]
            pub fn add_byte_extra(&mut self, byte_extra: flatbuffers::WIPOffset<Byte_Extra<'b>>) {
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<Byte_Extra>>(
                        Material::VT_BYTE_EXTRA,
                        byte_extra,
                    );
            }
            ...
            pub fn add_int_extra(&mut self, int_extra: flatbuffers::WIPOffset<Int_Extra<'b>>) {
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<Int_Extra>>(
                        Material::VT_INT_EXTRA,
                        int_extra,
                    );
            }
        ...
        impl MaterialT {
            pub fn pack<'b>(
                ...
                let unk_5 = self.unk_5.as_ref().map(|x| _fbb.create_string(x));
                ...
                let unk_8 = self.unk_8.as_ref().map(|x| _fbb.create_string(x));
                let int_parameter = self.int_parameter.as_ref().map(|x| {
                    let w: Vec<_> = x.iter().map(|t| t.pack(_fbb)).collect();
                    _fbb.create_vector(&w)
                });
                let unk_10 = self.unk_10.as_ref().map(|x| _fbb.create_string(x));
                let unk_11 = self.unk_11.as_ref().map(|x| _fbb.create_string(x));
                let unk_12 = self.unk_12.as_ref().map(|x| _fbb.create_string(x));
                let byte_extra = self.byte_extra.as_ref().map(|x| x.pack(_fbb));
                let int_extra = self.int_extra.as_ref().map(|x| x.pack(_fbb));
                let alpha_type = self.alpha_type.as_ref().map(|x| _fbb.create_string(x));
                Material::create(
                    _fbb,
                    &MaterialArgs {
                        name,
        ...
        pub struct TRMTRArgs<'a> {
            ...
            pub materials: Option<
                flatbuffers::WIPOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Material<'a>>>,
                >,
            >,
        }
        ...
        impl<'a: 'b, 'b> TRMTRBuilder<'a, 'b> {
            ...
            pub fn add_materials(
                ...
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<_>>(TRMTR::VT_MATERIALS, materials);
            }
            #[inline]
        ...
        impl TRMTRT {
            pub fn pack<'b>(
                ...
                TRMTR::create(_fbb, &TRMTRArgs { res_0, materials })
            }
        }
        #[inline]
        ...
        pub fn size_prefixed_root_as_trmtr(
            buf: &[u8],
        ) -> Result<TRMTR, flatbuffers::InvalidFlatbuffer> {
        ...
        #[inline]
        pub fn finish_size_prefixed_trmtr_buffer<'a, 'b>(
            fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
            root: flatbuffers::WIPOffset<TRMTR<'a>>,
        ) {
