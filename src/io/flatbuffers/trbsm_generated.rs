    ...
    pub mod model {
        ...
        impl<'a> UnkEntry<'a> {
            ...
            pub fn name(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<flatbuffers::ForwardsUOffset<&str>>(UnkEntry::VT_NAME, None)
                }
            }
        }
        ...
        impl<'a: 'b, 'b> UnkEntryBuilder<'a, 'b> {
            ...
            pub fn add_name(&mut self, name: flatbuffers::WIPOffset<&'b str>) {
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<_>>(UnkEntry::VT_NAME, name);
            }
            #[inline]
            pub fn new(
        ...
        impl UnkEntryT {
            pub fn pack<'b>(
                ...
                UnkEntry::create(_fbb, &UnkEntryArgs { name })
            }
        }
        ...
        impl<'a> BoneEntry<'a> {
            ...
            pub fn name(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<flatbuffers::ForwardsUOffset<&str>>(BoneEntry::VT_NAME, None)
                }
            }
            #[inline]
            pub fn slots(
            ...
            pub fn unk_3(&self) -> f32 {
                ...
                unsafe {
                    self._tab
                        .get::<f32>(BoneEntry::VT_UNK_3, Some(0.0))
                        .unwrap()
                }
            }
        }
        ...
        impl<'a: 'b, 'b> BoneEntryBuilder<'a, 'b> {
            ...
            pub fn add_name(&mut self, name: flatbuffers::WIPOffset<&'b str>) {
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<_>>(BoneEntry::VT_NAME, name);
            }
            #[inline]
            pub fn add_slots(
                &mut self,
                ...
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<_>>(BoneEntry::VT_SLOTS, slots);
            }
            #[inline]
        ...
        impl BoneEntryT {
            pub fn pack<'b>(
                ...
                let unk_3 = self.unk_3;
                BoneEntry::create(_fbb, &BoneEntryArgs { name, slots, unk_3 })
            }
        }
        ...
        impl<'a> ScalerEntry<'a> {
            ...
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                ...
                if let Some(x) = args.slot_name {
                    builder.add_slot_name(x);
                }
                if let Some(x) = args.name {
                    builder.add_name(x);
                }
            ...
            pub fn unpack(&self) -> ScalerEntryT {
                ...
                let slot_name = self
                    ...
                    .map(|x| x.iter().map(|s| s.to_string()).collect());
                let unk_3 = self.unk_3();
                let unk_4 = self.unk_4().map(|x| x.into_iter().collect());
                ScalerEntryT {
                    name,
                    slot_name,
                    unk_3,
            ...
            pub fn name(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<flatbuffers::ForwardsUOffset<&str>>(ScalerEntry::VT_NAME, None)
                }
            }
            #[inline]
            pub fn slot_name(
        ...
        impl flatbuffers::Verifiable for ScalerEntry<'_> {
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    ...
                    .visit_field::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<&'_ str>>,
                    >>("slot_name", Self::VT_SLOT_NAME, false)?
        ...
        impl<'a: 'b, 'b> ScalerEntryBuilder<'a, 'b> {
            ...
            pub fn add_name(&mut self, name: flatbuffers::WIPOffset<&'b str>) {
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<_>>(ScalerEntry::VT_NAME, name);
            }
            #[inline]
            pub fn add_slot_name(
                &mut self,
                slot_name: flatbuffers::WIPOffset<
                    flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<&'b str>>,
                >,
            ) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                    ScalerEntry::VT_SLOT_NAME,
                    slot_name,
                );
            }
            #[inline]
            ...
            pub fn add_unk_4(
                &mut self,
                unk_4: flatbuffers::WIPOffset<flatbuffers::Vector<'b, f32>>,
            ) {
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<_>>(ScalerEntry::VT_UNK_4, unk_4);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
            ) -> ScalerEntryBuilder<'a, 'b> {
                let start = _fbb.start_table();
                ScalerEntryBuilder {
                    fbb_: _fbb,
                    start_: start,
        ...
        impl ScalerEntryT {
            pub fn pack<'b>(
                ...
                let unk_3 = self.unk_3;
                let unk_4 = self.unk_4.as_ref().map(|x| _fbb.create_vector(x));
                ScalerEntry::create(
                    _fbb,
                    &ScalerEntryArgs {
                        name,
        ...
        impl<'a> MeshEntry<'a> {
            ...
            pub fn name(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<flatbuffers::ForwardsUOffset<&str>>(MeshEntry::VT_NAME, None)
                }
            }
            #[inline]
            pub fn slot_name(
        ...
        impl<'a: 'b, 'b> MeshEntryBuilder<'a, 'b> {
            ...
            pub fn add_name(&mut self, name: flatbuffers::WIPOffset<&'b str>) {
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<_>>(MeshEntry::VT_NAME, name);
            }
            #[inline]
            pub fn add_slot_name(
                &mut self,
        ...
        impl MeshEntryT {
            pub fn pack<'b>(
                ...
                MeshEntry::create(_fbb, &MeshEntryArgs { name, slot_name })
            }
        }
        ...
        impl<'a> TRBSM<'a> {
            ...
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                ...
                if let Some(x) = args.unk {
                    builder.add_unk(x);
                }
                if let Some(x) = args.mesh {
                    builder.add_mesh(x);
                }
                if let Some(x) = args.scalers {
                    builder.add_scalers(x);
                }
            ...
            pub fn unpack(&self) -> TRBSMT {
                ...
                let mesh = self.mesh().map(|x| x.iter().map(|t| t.unpack()).collect());
                let unk = self.unk().map(|x| Box::new(x.unpack()));
                TRBSMT {
                    bones,
                    scalers,
                    mesh,
            ...
            pub fn bones(
                &self,
            ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BoneEntry<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BoneEntry>>,
                    >>(TRBSM::VT_BONES, None)
                }
            }
            #[inline]
            pub fn scalers(
                &self,
            ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<ScalerEntry<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<ScalerEntry>>,
                    >>(TRBSM::VT_SCALERS, None)
                }
            }
            #[inline]
            pub fn mesh(
                &self,
            ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MeshEntry<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MeshEntry>>,
                    >>(TRBSM::VT_MESH, None)
                }
            }
            #[inline]
            pub fn unk(&self) -> Option<UnkEntry<'a>> {
                ...
                unsafe {
                    self._tab
                        .get::<flatbuffers::ForwardsUOffset<UnkEntry>>(TRBSM::VT_UNK, None)
                }
            }
        }
        ...
        impl flatbuffers::Verifiable for TRBSM<'_> {
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    .visit_field::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<BoneEntry>>,
                    >>("bones", Self::VT_BONES, false)?
                    .visit_field::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<ScalerEntry>>,
                    >>("scalers", Self::VT_SCALERS, false)?
                    .visit_field::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<MeshEntry>>,
                    >>("mesh", Self::VT_MESH, false)?
                    .visit_field::<flatbuffers::ForwardsUOffset<UnkEntry>>(
                        "unk",
                        Self::VT_UNK,
                        false,
                    )?
        ...
        pub struct TRBSMArgs<'a> {
            pub bones: Option<
                flatbuffers::WIPOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BoneEntry<'a>>>,
                >,
            >,
            pub scalers: Option<
                flatbuffers::WIPOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<ScalerEntry<'a>>>,
                >,
            >,
            pub mesh: Option<
                flatbuffers::WIPOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MeshEntry<'a>>>,
                >,
            >,
        ...
        impl<'a: 'b, 'b> TRBSMBuilder<'a, 'b> {
            ...
            pub fn add_bones(
                ...
                bones: flatbuffers::WIPOffset<
                    flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<BoneEntry<'b>>>,
                >,
            ) {
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<_>>(TRBSM::VT_BONES, bones);
            }
            #[inline]
            pub fn add_scalers(
                &mut self,
                scalers: flatbuffers::WIPOffset<
                    flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<ScalerEntry<'b>>>,
                >,
            ) {
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<_>>(TRBSM::VT_SCALERS, scalers);
            }
            #[inline]
            pub fn add_mesh(
                &mut self,
                mesh: flatbuffers::WIPOffset<
                    flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<MeshEntry<'b>>>,
                >,
            ) {
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<_>>(TRBSM::VT_MESH, mesh);
            }
            #[inline]
            pub fn add_unk(&mut self, unk: flatbuffers::WIPOffset<UnkEntry<'b>>) {
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<UnkEntry>>(TRBSM::VT_UNK, unk);
            }
            #[inline]
        ...
        impl TRBSMT {
            pub fn pack<'b>(
                ...
                let unk = self.unk.as_ref().map(|x| x.pack(_fbb));
                TRBSM::create(
                    _fbb,
                    &TRBSMArgs {
                        bones,
        ...
        pub fn size_prefixed_root_as_trbsm(
            buf: &[u8],
        ) -> Result<TRBSM, flatbuffers::InvalidFlatbuffer> {
        ...
        #[inline]
        pub fn finish_size_prefixed_trbsm_buffer<'a, 'b>(
            fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
            root: flatbuffers::WIPOffset<TRBSM<'a>>,
        ) {
