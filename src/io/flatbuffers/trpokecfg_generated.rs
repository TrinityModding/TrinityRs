    ...
    pub mod model {
        ...
        impl<'a> TRPOKECFG<'a> {
            ...
            pub fn unk_1(&self) -> f32 {
                ...
                unsafe {
                    self._tab
                        .get::<f32>(TRPOKECFG::VT_UNK_1, Some(0.0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn unk_2(&self) -> f32 {
                ...
                unsafe {
                    self._tab
                        .get::<f32>(TRPOKECFG::VT_UNK_2, Some(0.0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn unk_3(&self) -> f32 {
                ...
                unsafe {
                    self._tab
                        .get::<f32>(TRPOKECFG::VT_UNK_3, Some(0.0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn unk_4(&self) -> f32 {
                ...
                unsafe {
                    self._tab
                        .get::<f32>(TRPOKECFG::VT_UNK_4, Some(0.0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn unk_5(&self) -> f32 {
                ...
                unsafe {
                    self._tab
                        .get::<f32>(TRPOKECFG::VT_UNK_5, Some(0.0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn unk_6(&self) -> f32 {
                ...
                unsafe {
                    self._tab
                        .get::<f32>(TRPOKECFG::VT_UNK_6, Some(0.0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn unk_7(&self) -> f32 {
                ...
                unsafe {
                    self._tab
                        .get::<f32>(TRPOKECFG::VT_UNK_7, Some(0.0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn unk_8(&self) -> f32 {
                ...
                unsafe {
                    self._tab
                        .get::<f32>(TRPOKECFG::VT_UNK_8, Some(0.0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn unk_9(&self) -> f32 {
                ...
                unsafe {
                    self._tab
                        .get::<f32>(TRPOKECFG::VT_UNK_9, Some(0.0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn unk_10(&self) -> f32 {
                ...
                unsafe {
                    self._tab
                        .get::<f32>(TRPOKECFG::VT_UNK_10, Some(0.0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn unk_11(&self) -> f32 {
                ...
                unsafe {
                    self._tab
                        .get::<f32>(TRPOKECFG::VT_UNK_11, Some(0.0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn unk_12(&self) -> f32 {
                ...
                unsafe {
                    self._tab
                        .get::<f32>(TRPOKECFG::VT_UNK_12, Some(0.0))
                        .unwrap()
                }
            }
        }
        ...
        impl<'a: 'b, 'b> TRPOKECFGBuilder<'a, 'b> {
            ...
            pub fn add_unk_10(&mut self, unk_10: f32) {
                self.fbb_
                    .push_slot::<f32>(TRPOKECFG::VT_UNK_10, unk_10, 0.0);
            }
            #[inline]
            pub fn add_unk_11(&mut self, unk_11: f32) {
                self.fbb_
                    .push_slot::<f32>(TRPOKECFG::VT_UNK_11, unk_11, 0.0);
            }
            #[inline]
            pub fn add_unk_12(&mut self, unk_12: f32) {
                self.fbb_
                    .push_slot::<f32>(TRPOKECFG::VT_UNK_12, unk_12, 0.0);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
            ) -> TRPOKECFGBuilder<'a, 'b> {
        ...
        pub fn size_prefixed_root_as_trpokecfg(
            buf: &[u8],
        ) -> Result<TRPOKECFG, flatbuffers::InvalidFlatbuffer> {
        ...
        #[inline]
        pub fn finish_size_prefixed_trpokecfg_buffer<'a, 'b>(
            fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
            root: flatbuffers::WIPOffset<TRPOKECFG<'a>>,
        ) {
