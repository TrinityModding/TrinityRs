...
pub mod titan {
    ...
    pub mod model {
        ...
        impl<'b> flatbuffers::Push for Vec3i {
            ...
            unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
                let src =
                    ::core::slice::from_raw_parts(self as *const Vec3i as *const u8, Self::size());
                dst.copy_from_slice(src);
            }
        }
        ...
        impl<'a> Table2<'a> {
            ...
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                ...
                if let Some(x) = args.shape_name {
                    builder.add_shape_name(x);
                }
                builder.finish()
            }

            pub fn unpack(&self) -> Table2T {
                let shape_name = self.shape_name().map(|x| x.to_string());
                Table2T { shape_name }
            }
            ...
            pub fn shape_name(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<flatbuffers::ForwardsUOffset<&str>>(Table2::VT_SHAPE_NAME, None)
                }
            }
        }
        ...
        impl Table2T {
            pub fn pack<'b>(
                ...
                let shape_name = self.shape_name.as_ref().map(|x| _fbb.create_string(x));
                Table2::create(_fbb, &Table2Args { shape_name })
            }
        }
        ...
        impl<'a> LookupTable<'a> {
            ...
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                ...
                if let Some(x) = args.some_positions {
                    builder.add_some_positions(x);
                }
                if let Some(x) = args.base_shape {
                    builder.add_base_shape(x);
                }
                if let Some(x) = args.mesh_names {
                    builder.add_mesh_names(x);
                }
            ...
            pub fn unpack(&self) -> LookupTableT {
                ...
                let unk_2 = self.unk_2().map(|x| x.unpack());
                let mesh_names = self
                    .mesh_names()
            ...
            pub fn shape_name(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<flatbuffers::ForwardsUOffset<&str>>(LookupTable::VT_SHAPE_NAME, None)
                }
            }
            #[inline]
            pub fn name(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<flatbuffers::ForwardsUOffset<&str>>(LookupTable::VT_NAME, None)
                }
            }
            #[inline]
            ...
            ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>
            {
                ...
                unsafe {
                    ...
                    >>(LookupTable::VT_MESH_NAMES, None)
                }
            }
            #[inline]
            pub fn base_shape(
                &self,
            ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Table2<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Table2>>,
                    >>(LookupTable::VT_BASE_SHAPE, None)
                }
            }
            #[inline]
            pub fn some_positions(&self) -> Option<flatbuffers::Vector<'a, Vec3f>> {
                ...
                unsafe {
                    self._tab
                        .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, Vec3f>>>(
                            LookupTable::VT_SOME_POSITIONS,
                            None,
                        )
                }
            }
        ...
        impl flatbuffers::Verifiable for LookupTable<'_> {
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    ...
                    >>("mesh_names", Self::VT_MESH_NAMES, false)?
                    .visit_field::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Table2>>,
                    >>("base_shape", Self::VT_BASE_SHAPE, false)?
                    .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, Vec3f>>>(
                        "some_positions",
                        Self::VT_SOME_POSITIONS,
                        false,
                    )?
                    .finish();
                Ok(())
        ...
        pub struct LookupTableArgs<'a> {
            ...
            pub mesh_names: Option<
                flatbuffers::WIPOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>,
                >,
            >,
            pub base_shape: Option<
                flatbuffers::WIPOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Table2<'a>>>,
                >,
            >,
        ...
        impl<'a: 'b, 'b> LookupTableBuilder<'a, 'b> {
            ...
            pub fn add_name(&mut self, name: flatbuffers::WIPOffset<&'b str>) {
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<_>>(LookupTable::VT_NAME, name);
            }
            #[inline]
            pub fn add_unk_2(&mut self, unk_2: &Vec3i) {
                self.fbb_
                    .push_slot_always::<&Vec3i>(LookupTable::VT_UNK_2, unk_2);
            }
            #[inline]
            pub fn add_mesh_names(
                &mut self,
                mesh_names: flatbuffers::WIPOffset<
                    flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<&'b str>>,
                >,
            ) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                    LookupTable::VT_MESH_NAMES,
                    mesh_names,
                );
            }
            #[inline]
            pub fn add_base_shape(
                &mut self,
                base_shape: flatbuffers::WIPOffset<
                    flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<Table2<'b>>>,
                >,
            ) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                    LookupTable::VT_BASE_SHAPE,
                    base_shape,
                );
            }
            #[inline]
            pub fn add_some_positions(
                &mut self,
                some_positions: flatbuffers::WIPOffset<flatbuffers::Vector<'b, Vec3f>>,
            ) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                    LookupTable::VT_SOME_POSITIONS,
                    some_positions,
        ...
        impl<'a> TRLTT<'a> {
            ...
            pub fn entries(
                &self,
            ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<LookupTable<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<LookupTable>>,
                    >>(TRLTT::VT_ENTRIES, None)
                }
            }
        }
        ...
        impl flatbuffers::Verifiable for TRLTT<'_> {
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    ...
                    .visit_field::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<LookupTable>>,
        ...
        pub struct TRLTTArgs<'a> {
            ...
            pub entries: Option<
                flatbuffers::WIPOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<LookupTable<'a>>>,
                >,
            >,
        }
        ...
        impl<'a: 'b, 'b> TRLTTBuilder<'a, 'b> {
            ...
            pub fn add_entries(
                ...
                entries: flatbuffers::WIPOffset<
                    flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<LookupTable<'b>>>,
                >,
            ) {
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<_>>(TRLTT::VT_ENTRIES, entries);
            }
            #[inline]
        ...
        impl TRLTTT {
            pub fn pack<'b>(
                ...
                TRLTT::create(_fbb, &TRLTTArgs { res_0, entries })
            }
        }
        #[inline]
        ...
        pub fn size_prefixed_root_as_trltt(
            buf: &[u8],
        ) -> Result<TRLTT, flatbuffers::InvalidFlatbuffer> {
        ...
        #[inline]
        pub fn finish_size_prefixed_trltt_buffer<'a, 'b>(
            fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
            root: flatbuffers::WIPOffset<TRLTT<'a>>,
        ) {
