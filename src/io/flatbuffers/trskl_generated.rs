...
pub mod titan {
    ...
    pub mod model {
        ...
        pub const ENUM_VALUES_NODE_TYPE: [NodeType; 3] =
            [NodeType::Default, NodeType::Chained, NodeType::Floating];
        ...
        impl NodeType {
            ...
            pub const ENUM_VALUES: &'static [Self] =
                &[Self::Default, Self::Chained, Self::Floating];
        ...
        impl<'a> Transform<'a> {
            ...
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                ...
                if let Some(x) = args.VecTranslate {
                    builder.add_VecTranslate(x);
                }
                if let Some(x) = args.VecRot {
                    builder.add_VecRot(x);
                }
                if let Some(x) = args.VecScale {
                    builder.add_VecScale(x);
                }
                builder.finish()
            }

            pub fn unpack(&self) -> TransformT {
                let VecScale = self.VecScale().map(|x| x.unpack());
                let VecRot = self.VecRot().map(|x| x.unpack());
                let VecTranslate = self.VecTranslate().map(|x| x.unpack());
                TransformT {
                    VecScale,
                    VecRot,
                    VecTranslate,
        ...
        impl<'a: 'b, 'b> TransformBuilder<'a, 'b> {
            ...
            pub fn add_VecScale(&mut self, VecScale: &Vec3) {
                self.fbb_
                    .push_slot_always::<&Vec3>(Transform::VT_VECSCALE, VecScale);
            }
            #[inline]
            pub fn add_VecRot(&mut self, VecRot: &Vec3) {
                self.fbb_
                    .push_slot_always::<&Vec3>(Transform::VT_VECROT, VecRot);
            }
            #[inline]
            pub fn add_VecTranslate(&mut self, VecTranslate: &Vec3) {
                self.fbb_
                    .push_slot_always::<&Vec3>(Transform::VT_VECTRANSLATE, VecTranslate);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
            ) -> TransformBuilder<'a, 'b> {
        ...
        impl<'a> TransformNode<'a> {
            ...
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                ...
                if let Some(x) = args.effect_node {
                    builder.add_effect_node(x);
                }
                builder.add_rig_idx(args.rig_idx);
                builder.add_parent_idx(args.parent_idx);
                if let Some(x) = args.rotatePivot {
                    builder.add_rotatePivot(x);
                }
                if let Some(x) = args.scalePivot {
                    builder.add_scalePivot(x);
                }
            ...
            pub fn unpack(&self) -> TransformNodeT {
                ...
                let transform = self.transform().map(|x| Box::new(x.unpack()));
                let scalePivot = self.scalePivot().map(|x| x.unpack());
                let rotatePivot = self.rotatePivot().map(|x| x.unpack());
                let parent_idx = self.parent_idx();
                let rig_idx = self.rig_idx();
                let effect_node = self.effect_node().map(|x| x.to_string());
            ...
            pub fn name(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<flatbuffers::ForwardsUOffset<&str>>(TransformNode::VT_NAME, None)
                }
            }
            #[inline]
            ...
            pub fn parent_idx(&self) -> i32 {
                ...
                unsafe {
                    self._tab
                        .get::<i32>(TransformNode::VT_PARENT_IDX, Some(-1))
                        .unwrap()
                }
            }
            #[inline]
            pub fn rig_idx(&self) -> i32 {
                ...
                unsafe {
                    self._tab
                        .get::<i32>(TransformNode::VT_RIG_IDX, Some(-1))
                        .unwrap()
                }
            }
            #[inline]
            ...
            pub fn type_(&self) -> NodeType {
                ...
                unsafe {
                    self._tab
                        .get::<NodeType>(TransformNode::VT_TYPE_, Some(NodeType::Default))
                        .unwrap()
                }
            }
        }
        ...
        impl<'a: 'b, 'b> TransformNodeBuilder<'a, 'b> {
            ...
            pub fn add_name(&mut self, name: flatbuffers::WIPOffset<&'b str>) {
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<_>>(TransformNode::VT_NAME, name);
            }
            #[inline]
            ...
            pub fn add_scalePivot(&mut self, scalePivot: &Vec3) {
                self.fbb_
                    .push_slot_always::<&Vec3>(TransformNode::VT_SCALEPIVOT, scalePivot);
            }
            #[inline]
            pub fn add_rotatePivot(&mut self, rotatePivot: &Vec3) {
                self.fbb_
                    .push_slot_always::<&Vec3>(TransformNode::VT_ROTATEPIVOT, rotatePivot);
            }
            #[inline]
            pub fn add_parent_idx(&mut self, parent_idx: i32) {
                self.fbb_
                    .push_slot::<i32>(TransformNode::VT_PARENT_IDX, parent_idx, -1);
            }
            #[inline]
            pub fn add_rig_idx(&mut self, rig_idx: i32) {
                self.fbb_
                    .push_slot::<i32>(TransformNode::VT_RIG_IDX, rig_idx, -1);
            }
            #[inline]
            ...
            pub fn add_type_(&mut self, type_: NodeType) {
                self.fbb_
                    .push_slot::<NodeType>(TransformNode::VT_TYPE_, type_, NodeType::Default);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
            ) -> TransformNodeBuilder<'a, 'b> {
                let start = _fbb.start_table();
        ...
        impl TransformNodeT {
            pub fn pack<'b>(
                ...
                let transform = self.transform.as_ref().map(|x| x.pack(_fbb));
                ...
                let parent_idx = self.parent_idx;
                let rig_idx = self.rig_idx;
                let effect_node = self.effect_node.as_ref().map(|x| _fbb.create_string(x));
                let type_ = self.type_;
        ...
        impl<'a> IKControl<'a> {
            ...
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                ...
                if let Some(x) = args.ik_rot {
                    builder.add_ik_rot(x);
                }
                if let Some(x) = args.ik_pos {
                    builder.add_ik_pos(x);
                }
                builder.add_res_4(args.res_4);
                if let Some(x) = args.ik_type {
                    builder.add_ik_type(x);
                }
                if let Some(x) = args.ik_chain_end {
                    builder.add_ik_chain_end(x);
                }
                if let Some(x) = args.ik_chain_start {
                    builder.add_ik_chain_start(x);
                }
                if let Some(x) = args.ik_name {
                    builder.add_ik_name(x);
                }
                builder.finish()
            }

            pub fn unpack(&self) -> IKControlT {
                let ik_name = self.ik_name().map(|x| x.to_string());
                let ik_chain_start = self.ik_chain_start().map(|x| x.to_string());
                let ik_chain_end = self.ik_chain_end().map(|x| x.to_string());
                let ik_type = self.ik_type().map(|x| x.to_string());
                let res_4 = self.res_4();
                let ik_pos = self.ik_pos().map(|x| x.unpack());
                let ik_rot = self.ik_rot().map(|x| x.unpack());
                IKControlT {
                    ik_name,
                    ik_chain_start,
                    ik_chain_end,
            ...
            pub fn ik_name(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<flatbuffers::ForwardsUOffset<&str>>(IKControl::VT_IK_NAME, None)
                }
            }
            #[inline]
            ...
            pub fn ik_chain_end(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<flatbuffers::ForwardsUOffset<&str>>(IKControl::VT_IK_CHAIN_END, None)
                }
            }
            #[inline]
            pub fn ik_type(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<flatbuffers::ForwardsUOffset<&str>>(IKControl::VT_IK_TYPE, None)
                }
            }
            #[inline]
        ...
        impl flatbuffers::Verifiable for IKControl<'_> {
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    ...
                    .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                        "ik_chain_start",
                        Self::VT_IK_CHAIN_START,
                        false,
                    )?
                    .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                        "ik_chain_end",
                        Self::VT_IK_CHAIN_END,
                        false,
                    )?
                    .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                        "ik_type",
        ...
        impl<'a: 'b, 'b> IKControlBuilder<'a, 'b> {
            ...
            pub fn add_ik_name(&mut self, ik_name: flatbuffers::WIPOffset<&'b str>) {
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<_>>(IKControl::VT_IK_NAME, ik_name);
            }
            #[inline]
            ...
            pub fn add_ik_type(&mut self, ik_type: flatbuffers::WIPOffset<&'b str>) {
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<_>>(IKControl::VT_IK_TYPE, ik_type);
            }
            #[inline]
            ...
            pub fn add_ik_pos(&mut self, ik_pos: &Vec3) {
                self.fbb_
                    .push_slot_always::<&Vec3>(IKControl::VT_IK_POS, ik_pos);
            }
            #[inline]
            pub fn add_ik_rot(&mut self, ik_rot: &Vec4) {
                self.fbb_
                    .push_slot_always::<&Vec4>(IKControl::VT_IK_ROT, ik_rot);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
            ) -> IKControlBuilder<'a, 'b> {
                let start = _fbb.start_table();
                IKControlBuilder {
                    fbb_: _fbb,
                    start_: start,
        ...
        impl IKControlT {
            pub fn pack<'b>(
                ...
                let ik_name = self.ik_name.as_ref().map(|x| _fbb.create_string(x));
                let ik_chain_start = self.ik_chain_start.as_ref().map(|x| _fbb.create_string(x));
                let ik_chain_end = self.ik_chain_end.as_ref().map(|x| _fbb.create_string(x));
                let ik_type = self.ik_type.as_ref().map(|x| _fbb.create_string(x));
                let res_4 = self.res_4;
        ...
        impl BoneMatrixT {
            pub fn pack<'b>(
                ...
                let w = w_tmp.as_ref();
                BoneMatrix::create(_fbb, &BoneMatrixArgs { x, y, z, w })
            }
        }
        pub enum BoneOffset {}
        #[derive(Copy, Clone, PartialEq)]
        ...
        impl<'a> Bone<'a> {
            ...
            pub fn unpack(&self) -> BoneT {
                ...
                let matrix = self.matrix().map(|x| Box::new(x.unpack()));
                BoneT {
                    inherit_position,
                    unk_bool_2,
                    matrix,
            ...
            pub fn inherit_position(&self) -> u8 {
                ...
                unsafe {
                    self._tab
                        .get::<u8>(Bone::VT_INHERIT_POSITION, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            ...
            pub fn matrix(&self) -> Option<BoneMatrix<'a>> {
                ...
                unsafe {
                    self._tab
                        .get::<flatbuffers::ForwardsUOffset<BoneMatrix>>(Bone::VT_MATRIX, None)
                }
            }
        }
        ...
        impl flatbuffers::Verifiable for Bone<'_> {
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    ...
                    .visit_field::<flatbuffers::ForwardsUOffset<BoneMatrix>>(
                        "matrix",
                        Self::VT_MATRIX,
                        false,
                    )?
        ...
        impl<'a: 'b, 'b> BoneBuilder<'a, 'b> {
            ...
            pub fn add_inherit_position(&mut self, inherit_position: u8) {
                self.fbb_
                    .push_slot::<u8>(Bone::VT_INHERIT_POSITION, inherit_position, 0);
            }
            #[inline]
            pub fn add_unk_bool_2(&mut self, unk_bool_2: u8) {
                self.fbb_
                    .push_slot::<u8>(Bone::VT_UNK_BOOL_2, unk_bool_2, 0);
            }
            #[inline]
            pub fn add_matrix(&mut self, matrix: flatbuffers::WIPOffset<BoneMatrix<'b>>) {
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<BoneMatrix>>(
                        Bone::VT_MATRIX,
                        matrix,
                    );
            }
        ...
        impl BoneT {
            pub fn pack<'b>(
                ...
                let inherit_position = self.inherit_position;
                let unk_bool_2 = self.unk_bool_2;
                let matrix = self.matrix.as_ref().map(|x| x.pack(_fbb));
                Bone::create(
                    _fbb,
                    &BoneArgs {
                        inherit_position,
        ...
        impl<'a> TRSKL<'a> {
            ...
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                ...
                if let Some(x) = args.iks {
                    builder.add_iks(x);
                }
                if let Some(x) = args.bones {
                    builder.add_bones(x);
                }
                if let Some(x) = args.transform_nodes {
                    builder.add_transform_nodes(x);
                }
            ...
            pub fn unpack(&self) -> TRSKLT {
                ...
                let transform_nodes = self
                    .transform_nodes()
                    .map(|x| x.iter().map(|t| t.unpack()).collect());
                let bones = self.bones().map(|x| x.iter().map(|t| t.unpack()).collect());
                let iks = self.iks().map(|x| x.iter().map(|t| t.unpack()).collect());
            ...
            pub fn transform_nodes(
                &self,
            ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<TransformNode<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<TransformNode>>,
                    >>(TRSKL::VT_TRANSFORM_NODES, None)
                }
            }
            #[inline]
            pub fn bones(
                &self,
            ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Bone<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Bone>>,
                    >>(TRSKL::VT_BONES, None)
                }
            }
            #[inline]
            pub fn iks(
                &self,
            ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<IKControl<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<IKControl>>,
                    >>(TRSKL::VT_IKS, None)
                }
            }
            #[inline]
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    ...
                    .visit_field::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<TransformNode>>,
                    >>("transform_nodes", Self::VT_TRANSFORM_NODES, false)?
                    .visit_field::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Bone>>,
                    >>("bones", Self::VT_BONES, false)?
                    .visit_field::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<IKControl>>,
                    >>("iks", Self::VT_IKS, false)?
        ...
        pub struct TRSKLArgs<'a> {
            pub res_0: u32,
            pub transform_nodes: Option<
                flatbuffers::WIPOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<TransformNode<'a>>>,
                >,
            >,
            pub bones: Option<
                flatbuffers::WIPOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Bone<'a>>>,
                >,
            >,
            pub iks: Option<
                flatbuffers::WIPOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<IKControl<'a>>>,
                >,
            >,
            pub rig_offset: u32,
        }
        ...
        impl<'a: 'b, 'b> TRSKLBuilder<'a, 'b> {
            ...
            #[inline]
            pub fn add_transform_nodes(
                &mut self,
                transform_nodes: flatbuffers::WIPOffset<
                    flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<TransformNode<'b>>>,
                >,
            ) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                    TRSKL::VT_TRANSFORM_NODES,
                    transform_nodes,
                );
            }
            #[inline]
            pub fn add_bones(
                &mut self,
                bones: flatbuffers::WIPOffset<
                    flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<Bone<'b>>>,
                >,
            ) {
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<_>>(TRSKL::VT_BONES, bones);
            }
            #[inline]
            pub fn add_iks(
                &mut self,
                iks: flatbuffers::WIPOffset<
                    flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<IKControl<'b>>>,
                >,
            ) {
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<_>>(TRSKL::VT_IKS, iks);
            }
            #[inline]
            pub fn add_rig_offset(&mut self, rig_offset: u32) {
                self.fbb_
                    .push_slot::<u32>(TRSKL::VT_RIG_OFFSET, rig_offset, 0);
            }
            #[inline]
        ...
        pub fn size_prefixed_root_as_trskl(
            buf: &[u8],
        ) -> Result<TRSKL, flatbuffers::InvalidFlatbuffer> {
        ...
        #[inline]
        pub fn finish_size_prefixed_trskl_buffer<'a, 'b>(
            fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
            root: flatbuffers::WIPOffset<TRSKL<'a>>,
        ) {
