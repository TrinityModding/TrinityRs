...
impl<'a> MaterialSwitches<'a> {
  ...
  pub fn material_name(&self) -> Option<&'a str> {
    ...
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(MaterialSwitches::VT_MATERIAL_NAME, None)}
  }
  #[inline]
  pub fn material_flag(&self) -> u8 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u8>(MaterialSwitches::VT_MATERIAL_FLAG, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b> MaterialSwitchesBuilder<'a, 'b> {
  ...
  pub fn add_material_name(&mut self, material_name: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MaterialSwitches::VT_MATERIAL_NAME, material_name);
  }
  #[inline]
  pub fn add_material_flag(&mut self, material_flag: u8) {
    self.fbb_.push_slot::<u8>(MaterialSwitches::VT_MATERIAL_FLAG, material_flag, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> MaterialSwitchesBuilder<'a, 'b> {
...
impl MaterialSwitchesT {
  pub fn pack<'b>(
    ...
    let material_flag = self.material_flag;
    MaterialSwitches::create(_fbb, &MaterialSwitchesArgs{
      material_name,
      material_flag,
    })
  }
...
impl<'a> MaterialMapper<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    if let Some(x) = args.layer_name { builder.add_layer_name(x); }
    if let Some(x) = args.material_name { builder.add_material_name(x); }
  ...
  pub fn unpack(&self) -> MaterialMapperT {
    ...
    let layer_name = self.layer_name().map(|x| {
      x.to_string()
    });
    MaterialMapperT {
      mesh_name,
  ...
  pub fn mesh_name(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(MaterialMapper::VT_MESH_NAME, None)}
  }
  #[inline]
  pub fn material_name(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(MaterialMapper::VT_MATERIAL_NAME, None)}
  }
  #[inline]
  pub fn layer_name(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(MaterialMapper::VT_LAYER_NAME, None)}
  }
}
...
impl flatbuffers::Verifiable for MaterialMapper<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("material_name", Self::VT_MATERIAL_NAME, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("layer_name", Self::VT_LAYER_NAME, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b> MaterialMapperBuilder<'a, 'b> {
  ...
  pub fn add_mesh_name(&mut self, mesh_name: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MaterialMapper::VT_MESH_NAME, mesh_name);
  }
  #[inline]
  pub fn add_material_name(&mut self, material_name: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MaterialMapper::VT_MATERIAL_NAME, material_name);
  }
  #[inline]
  pub fn add_layer_name(&mut self, layer_name: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MaterialMapper::VT_LAYER_NAME, layer_name);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> MaterialMapperBuilder<'a, 'b> {
    let start = _fbb.start_table();
...
impl MaterialMapperT {
  pub fn pack<'b>(
    ...
    let layer_name = self.layer_name.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    MaterialMapper::create(_fbb, &MaterialMapperArgs{
      mesh_name,
      material_name,
      layer_name,
    })
...
impl<'a> EmbeddedTRACM<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    if let Some(x) = args.bytebuffer { builder.add_bytebuffer(x); }
    builder.finish()
  }

  pub fn unpack(&self) -> EmbeddedTRACMT {
    let bytebuffer = self.bytebuffer().map(|x| {
      x.into_iter().collect()
    });
    EmbeddedTRACMT {
      bytebuffer,
  ...
  pub fn bytebuffer(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(EmbeddedTRACM::VT_BYTEBUFFER, None)}
  }
}
...
impl flatbuffers::Verifiable for EmbeddedTRACM<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>("bytebuffer", Self::VT_BYTEBUFFER, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b> EmbeddedTRACMBuilder<'a, 'b> {
  #[inline]
  pub fn add_bytebuffer(&mut self, bytebuffer: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(EmbeddedTRACM::VT_BYTEBUFFER, bytebuffer);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> EmbeddedTRACMBuilder<'a, 'b> {
    let start = _fbb.start_table();
...
impl EmbeddedTRACMT {
  pub fn pack<'b>(
    ...
    let bytebuffer = self.bytebuffer.as_ref().map(|x|{
      _fbb.create_vector(x)
    });
    EmbeddedTRACM::create(_fbb, &EmbeddedTRACMArgs{
      bytebuffer,
    })
  }
}
...
impl<'a> MaterialProperties<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    if let Some(x) = args.res_5 { builder.add_res_5(x); }
    if let Some(x) = args.tracm { builder.add_tracm(x); }
    builder.add_unk_3(args.unk_3);
    builder.add_res_2(args.res_2);
    if let Some(x) = args.mappers { builder.add_mappers(x); }
  ...
  pub fn unpack(&self) -> MaterialPropertiesT {
    ...
    let mappers = self.mappers().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let res_2 = self.res_2();
    let unk_3 = self.unk_3();
    let tracm = self.tracm().map(|x| {
      Box::new(x.unpack())
    });
    let res_5 = self.res_5().map(|x| {
      x.into_iter().collect()
    });
    MaterialPropertiesT {
      name,
  ...
  pub fn name(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(MaterialProperties::VT_NAME, None)}
  }
  #[inline]
  pub fn mappers(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MaterialMapper<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MaterialMapper>>>>(MaterialProperties::VT_MAPPERS, None)}
  }
  #[inline]
  pub fn res_2(&self) -> u32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(MaterialProperties::VT_RES_2, Some(0)).unwrap()}
  }
  #[inline]
  pub fn unk_3(&self) -> u32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(MaterialProperties::VT_UNK_3, Some(0)).unwrap()}
  }
  #[inline]
  pub fn tracm(&self) -> Option<EmbeddedTRACM<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<EmbeddedTRACM>>(MaterialProperties::VT_TRACM, None)}
  }
  #[inline]
  pub fn res_5(&self) -> Option<flatbuffers::Vector<'a, u32>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u32>>>(MaterialProperties::VT_RES_5, None)}
  }
}
...
impl flatbuffers::Verifiable for MaterialProperties<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<MaterialMapper>>>>("mappers", Self::VT_MAPPERS, false)?
     .visit_field::<u32>("res_2", Self::VT_RES_2, false)?
     .visit_field::<u32>("unk_3", Self::VT_UNK_3, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<EmbeddedTRACM>>("tracm", Self::VT_TRACM, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u32>>>("res_5", Self::VT_RES_5, false)?
     .finish();
    Ok(())
  }
}
pub struct MaterialPropertiesArgs<'a> {
    ...
    pub mappers: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MaterialMapper<'a>>>>>,
    pub res_2: u32,
    pub unk_3: u32,
...
impl<'a: 'b, 'b> MaterialPropertiesBuilder<'a, 'b> {
  ...
  pub fn add_name(&mut self, name: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MaterialProperties::VT_NAME, name);
  }
  #[inline]
  pub fn add_mappers(&mut self, mappers: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<MaterialMapper<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MaterialProperties::VT_MAPPERS, mappers);
  }
  #[inline]
  pub fn add_res_2(&mut self, res_2: u32) {
    self.fbb_.push_slot::<u32>(MaterialProperties::VT_RES_2, res_2, 0);
  }
  #[inline]
  pub fn add_unk_3(&mut self, unk_3: u32) {
    self.fbb_.push_slot::<u32>(MaterialProperties::VT_UNK_3, unk_3, 0);
  }
  #[inline]
  pub fn add_tracm(&mut self, tracm: flatbuffers::WIPOffset<EmbeddedTRACM<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<EmbeddedTRACM>>(MaterialProperties::VT_TRACM, tracm);
  }
  #[inline]
  pub fn add_res_5(&mut self, res_5: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u32>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MaterialProperties::VT_RES_5, res_5);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> MaterialPropertiesBuilder<'a, 'b> {
    let start = _fbb.start_table();
...
impl MaterialPropertiesT {
  pub fn pack<'b>(
    ...
    let res_2 = self.res_2;
    let unk_3 = self.unk_3;
    let tracm = self.tracm.as_ref().map(|x|{
      x.pack(_fbb)
    });
    let res_5 = self.res_5.as_ref().map(|x|{
      _fbb.create_vector(x)
    });
    MaterialProperties::create(_fbb, &MaterialPropertiesArgs{
      name,
      mappers,
      res_2,
      unk_3,
...
impl<'a> MMT<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    if let Some(x) = args.material_properties { builder.add_material_properties(x); }
    if let Some(x) = args.material_switches { builder.add_material_switches(x); }
    if let Some(x) = args.material_name { builder.add_material_name(x); }
    if let Some(x) = args.name { builder.add_name(x); }
    builder.finish()
  }
  ...
  pub fn unpack(&self) -> MMTT {
    ...
    let material_switches = self.material_switches().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let material_properties = self.material_properties().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    MMTT {
      name,
  ...
  pub fn name(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(MMT::VT_NAME, None)}
  }
  #[inline]
  pub fn material_name(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(MMT::VT_MATERIAL_NAME, None)}
  }
  #[inline]
  pub fn material_switches(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MaterialSwitches<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MaterialSwitches>>>>(MMT::VT_MATERIAL_SWITCHES, None)}
  }
  #[inline]
  pub fn material_properties(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MaterialProperties<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MaterialProperties>>>>(MMT::VT_MATERIAL_PROPERTIES, None)}
  }
}
...
impl flatbuffers::Verifiable for MMT<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("name", Self::VT_NAME, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<&'_ str>>>>("material_name", Self::VT_MATERIAL_NAME, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<MaterialSwitches>>>>("material_switches", Self::VT_MATERIAL_SWITCHES, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<MaterialProperties>>>>("material_properties", Self::VT_MATERIAL_PROPERTIES, false)?
     .finish();
    Ok(())
  }
}
pub struct MMTArgs<'a> {
    pub name: Option<flatbuffers::WIPOffset<&'a str>>,
    pub material_name: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>,
    pub material_switches: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MaterialSwitches<'a>>>>>,
    pub material_properties: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MaterialProperties<'a>>>>>,
}
...
impl<'a: 'b, 'b> MMTBuilder<'a, 'b> {
  #[inline]
  pub fn add_name(&mut self, name: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MMT::VT_NAME, name);
  }
  #[inline]
  pub fn add_material_name(&mut self, material_name: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MMT::VT_MATERIAL_NAME, material_name);
  }
  #[inline]
  pub fn add_material_switches(&mut self, material_switches: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<MaterialSwitches<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MMT::VT_MATERIAL_SWITCHES, material_switches);
  }
  #[inline]
  pub fn add_material_properties(&mut self, material_properties: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<MaterialProperties<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MMT::VT_MATERIAL_PROPERTIES, material_properties);
  }
  #[inline]
...
impl<'a> TRMMT<'a> {
  ...
  #[inline]
  pub fn material(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MMT<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MMT>>>>(TRMMT::VT_MATERIAL, None)}
  }
}
...
impl flatbuffers::Verifiable for TRMMT<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<MMT>>>>("material", Self::VT_MATERIAL, false)?
     .finish();
    Ok(())
  }
}
pub struct TRMMTArgs<'a> {
    pub res_0: u32,
    pub res_1: u32,
    pub material: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MMT<'a>>>>>,
}
...
impl<'a: 'b, 'b> TRMMTBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_material(&mut self, material: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<MMT<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(TRMMT::VT_MATERIAL, material);
  }
  #[inline]
...
pub fn size_prefixed_root_as_trmmt(buf: &[u8]) -> Result<TRMMT, flatbuffers::InvalidFlatbuffer> {
...
#[inline]
pub fn finish_size_prefixed_trmmt_buffer<'a, 'b>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>, root: flatbuffers::WIPOffset<TRMMT<'a>>) {
