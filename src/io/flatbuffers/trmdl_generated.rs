...
impl<'a> trmeshes<'a> {
  ...
  pub fn filename(&self) -> Option<&'a str> {
    ...
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(trmeshes::VT_FILENAME, None)}
  }
}
...
impl<'a: 'b, 'b> trmeshesBuilder<'a, 'b> {
  ...
  pub fn add_filename(&mut self, filename: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(trmeshes::VT_FILENAME, filename);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> trmeshesBuilder<'a, 'b> {
...
impl trmeshesT {
  pub fn pack<'b>(
    ...
    trmeshes::create(_fbb, &trmeshesArgs{
      filename,
    })
  }
}
...
impl<'a> trskeleton<'a> {
  ...
  pub fn filename(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(trskeleton::VT_FILENAME, None)}
  }
}
...
impl<'a: 'b, 'b> trskeletonBuilder<'a, 'b> {
  #[inline]
  pub fn add_filename(&mut self, filename: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(trskeleton::VT_FILENAME, filename);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> trskeletonBuilder<'a, 'b> {
    let start = _fbb.start_table();
    trskeletonBuilder {
      fbb_: _fbb,
      start_: start,
...
impl trskeletonT {
  pub fn pack<'b>(
    ...
    trskeleton::create(_fbb, &trskeletonArgs{
      filename,
    })
  }
}
...
impl<'a: 'b, 'b> LodIndexBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> LodIndexBuilder<'a, 'b> {
    let start = _fbb.start_table();
    LodIndexBuilder {
      fbb_: _fbb,
      start_: start,
...
impl LodIndexT {
  pub fn pack<'b>(
    ...
    let unk0 = self.unk0;
    LodIndex::create(_fbb, &LodIndexArgs{
      unk0,
    })
  }
}
...
impl<'a> Lod<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    if let Some(x) = args.lod_type { builder.add_lod_type(x); }
  ...
  pub fn unpack(&self) -> LodT {
    ...
    let lod_type = self.lod_type().map(|x| {
      x.to_string()
    });
    LodT {
      index,
  ...
  #[inline]
  pub fn index(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<LodIndex<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<LodIndex>>>>(Lod::VT_INDEX, None)}
  }
  #[inline]
  pub fn lod_type(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Lod::VT_LOD_TYPE, None)}
  }
}
...
impl flatbuffers::Verifiable for Lod<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<LodIndex>>>>("index", Self::VT_INDEX, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("lod_type", Self::VT_LOD_TYPE, false)?
     .finish();
    Ok(())
  }
}
pub struct LodArgs<'a> {
    pub index: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<LodIndex<'a>>>>>,
...
impl<'a: 'b, 'b> LodBuilder<'a, 'b> {
  #[inline]
  pub fn add_index(&mut self, index: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<LodIndex<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Lod::VT_INDEX, index);
  }
  #[inline]
  pub fn add_lod_type(&mut self, lod_type: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Lod::VT_LOD_TYPE, lod_type);
  }
  #[inline]
...
impl LodT {
  pub fn pack<'b>(
    ...
    let lod_type = self.lod_type.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    Lod::create(_fbb, &LodArgs{
      index,
      lod_type,
    })
  }
...
impl<'a> TRMDL<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    if let Some(x) = args.unk_vec { builder.add_unk_vec(x); }
    if let Some(x) = args.bounds { builder.add_bounds(x); }
    if let Some(x) = args.lods { builder.add_lods(x); }
    if let Some(x) = args.materials { builder.add_materials(x); }
    if let Some(x) = args.skeleton { builder.add_skeleton(x); }
  ...
  pub fn unpack(&self) -> TRMDLT {
    ...
    let skeleton = self.skeleton().map(|x| {
      Box::new(x.unpack())
    });
    let materials = self.materials().map(|x| {
      x.iter().map(|s| s.to_string()).collect()
    });
    let lods = self.lods().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let bounds = self.bounds().map(|x| {
      Box::new(x.unpack())
    });
    let unk_vec = self.unk_vec().map(|x| {
      x.unpack()
    });
    let unk7 = self.unk7();
    let unk8 = self.unk8();
  ...
  #[inline]
  pub fn meshes(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<trmeshes<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<trmeshes>>>>(TRMDL::VT_MESHES, None)}
  }
  #[inline]
  pub fn skeleton(&self) -> Option<trskeleton<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<trskeleton>>(TRMDL::VT_SKELETON, None)}
  }
  #[inline]
  pub fn materials(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(TRMDL::VT_MATERIALS, None)}
  }
  #[inline]
  pub fn lods(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Lod<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Lod>>>>(TRMDL::VT_LODS, None)}
  }
  #[inline]
  pub fn bounds(&self) -> Option<Bounds<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Bounds>>(TRMDL::VT_BOUNDS, None)}
  }
  #[inline]
...
impl flatbuffers::Verifiable for TRMDL<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<u32>("unk0", Self::VT_UNK0, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<trmeshes>>>>("meshes", Self::VT_MESHES, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<trskeleton>>("skeleton", Self::VT_SKELETON, false)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Lod>>>>("lods", Self::VT_LODS, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<Bounds>>("bounds", Self::VT_BOUNDS, false)?
...
pub struct TRMDLArgs<'a> {
    pub unk0: u32,
    pub meshes: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<trmeshes<'a>>>>>,
    ...
    pub lods: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Lod<'a>>>>>,
...
impl<'a: 'b, 'b> TRMDLBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_meshes(&mut self, meshes: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<trmeshes<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(TRMDL::VT_MESHES, meshes);
  }
  #[inline]
  pub fn add_skeleton(&mut self, skeleton: flatbuffers::WIPOffset<trskeleton<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<trskeleton>>(TRMDL::VT_SKELETON, skeleton);
  }
  #[inline]
  pub fn add_materials(&mut self, materials: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(TRMDL::VT_MATERIALS, materials);
  }
  #[inline]
  pub fn add_lods(&mut self, lods: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Lod<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(TRMDL::VT_LODS, lods);
  }
  #[inline]
  pub fn add_bounds(&mut self, bounds: flatbuffers::WIPOffset<Bounds<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Bounds>>(TRMDL::VT_BOUNDS, bounds);
  }
  #[inline]
  pub fn add_unk_vec(&mut self, unk_vec: &Vec4) {
    self.fbb_.push_slot_always::<&Vec4>(TRMDL::VT_UNK_VEC, unk_vec);
  }
  #[inline]
...
impl TRMDLT {
  pub fn pack<'b>(
    ...
    let skeleton = self.skeleton.as_ref().map(|x|{
      x.pack(_fbb)
    });
...
pub fn size_prefixed_root_as_trmdl(buf: &[u8]) -> Result<TRMDL, flatbuffers::InvalidFlatbuffer> {
...
#[inline]
pub fn finish_size_prefixed_trmdl_buffer<'a, 'b>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>, root: flatbuffers::WIPOffset<TRMDL<'a>>) {
