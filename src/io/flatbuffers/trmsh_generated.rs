...
pub mod titan {
    ...
    pub mod model {
        ...
        impl<'b> flatbuffers::Push for Sphere {
            ...
            unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
                let src =
                    ::core::slice::from_raw_parts(self as *const Sphere as *const u8, Self::size());
        ...
        impl SphereT {
            pub fn pack(&self) -> Sphere {
                Sphere::new(self.x, self.y, self.z, self.radius)
            }
        }
        ...
        impl<'a: 'b, 'b> BoundingBoxBuilder<'a, 'b> {
            ...
            pub fn add_min(&mut self, min: &Vec3) {
                self.fbb_
                    .push_slot_always::<&Vec3>(BoundingBox::VT_MIN, min);
            }
            #[inline]
            pub fn add_max(&mut self, max: &Vec3) {
                self.fbb_
                    .push_slot_always::<&Vec3>(BoundingBox::VT_MAX, max);
            }
            #[inline]
            pub fn new(
        ...
        impl BoundingBoxT {
            pub fn pack<'b>(
                ...
                BoundingBox::create(_fbb, &BoundingBoxArgs { min, max })
            }
        }
        ...
        impl<'a> Influence<'a> {
            ...
            pub fn scale(&self) -> f32 {
                ...
                unsafe {
                    self._tab
                        .get::<f32>(Influence::VT_SCALE, Some(0.0))
                        .unwrap()
                }
            }
        }
        ...
        impl InfluenceT {
            pub fn pack<'b>(
                ...
                let index = self.index;
                let scale = self.scale;
                Influence::create(_fbb, &InfluenceArgs { index, scale })
            }
        }
        ...
        impl<'a> VertexAccessor<'a> {
            ...
            pub fn attr_0(&self) -> i32 {
                ...
                unsafe {
                    self._tab
                        .get::<i32>(VertexAccessor::VT_ATTR_0, Some(-1))
                        .unwrap()
                }
            }
            #[inline]
            pub fn attribute(&self) -> VertexAttribute {
                ...
                unsafe {
                    self._tab
                        .get::<VertexAttribute>(
                            VertexAccessor::VT_ATTRIBUTE,
                            Some(VertexAttribute::NONE),
                        )
                        .unwrap()
                }
            }
            ...
            pub fn attribute_layer(&self) -> u32 {
                ...
                unsafe {
                    self._tab
                        .get::<u32>(VertexAccessor::VT_ATTRIBUTE_LAYER, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn type_(&self) -> Type {
                ...
                unsafe {
                    self._tab
                        .get::<Type>(VertexAccessor::VT_TYPE_, Some(Type::NONE))
                        .unwrap()
                }
            }
            #[inline]
            pub fn position(&self) -> u32 {
                ...
                unsafe {
                    self._tab
                        .get::<u32>(VertexAccessor::VT_POSITION, Some(0))
                        .unwrap()
                }
            }
        }
        ...
        impl<'a: 'b, 'b> VertexAccessorBuilder<'a, 'b> {
            ...
            pub fn add_attr_0(&mut self, attr_0: i32) {
                self.fbb_
                    .push_slot::<i32>(VertexAccessor::VT_ATTR_0, attr_0, -1);
            }
            #[inline]
            pub fn add_attribute(&mut self, attribute: VertexAttribute) {
                self.fbb_.push_slot::<VertexAttribute>(
                    VertexAccessor::VT_ATTRIBUTE,
                    attribute,
                    VertexAttribute::NONE,
                );
            ...
            pub fn add_attribute_layer(&mut self, attribute_layer: u32) {
                self.fbb_
                    .push_slot::<u32>(VertexAccessor::VT_ATTRIBUTE_LAYER, attribute_layer, 0);
            }
            #[inline]
            pub fn add_type_(&mut self, type_: Type) {
                self.fbb_
                    .push_slot::<Type>(VertexAccessor::VT_TYPE_, type_, Type::NONE);
            }
            #[inline]
            pub fn add_position(&mut self, position: u32) {
                self.fbb_
                    .push_slot::<u32>(VertexAccessor::VT_POSITION, position, 0);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
            ) -> VertexAccessorBuilder<'a, 'b> {
                let start = _fbb.start_table();
        ...
        impl VertexSizeT {
            pub fn pack<'b>(
                ...
                let size_ = self.size_;
                VertexSize::create(_fbb, &VertexSizeArgs { size_ })
            }
        }
        ...
        impl<'a> VertexAccessors<'a> {
            ...
            pub fn unpack(&self) -> VertexAccessorsT {
                let attrs = self.attrs().map(|x| x.iter().map(|t| t.unpack()).collect());
                let size_ = self.size_().map(|x| x.iter().map(|t| t.unpack()).collect());
                VertexAccessorsT { attrs, size_ }
            }

            #[inline]
            pub fn attrs(
                &self,
            ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<VertexAccessor<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<VertexAccessor>>,
                    >>(VertexAccessors::VT_ATTRS, None)
                }
            }
            #[inline]
            pub fn size_(
                &self,
            ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<VertexSize<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<VertexSize>>,
                    >>(VertexAccessors::VT_SIZE_, None)
                }
            }
        }
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    .visit_field::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<VertexAccessor>>,
                    >>("attrs", Self::VT_ATTRS, false)?
                    .visit_field::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<VertexSize>>,
                    >>("size_", Self::VT_SIZE_, false)?
                    .finish();
                Ok(())
            }
        }
        pub struct VertexAccessorsArgs<'a> {
            pub attrs: Option<
                flatbuffers::WIPOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<VertexAccessor<'a>>>,
                >,
            >,
            pub size_: Option<
                flatbuffers::WIPOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<VertexSize<'a>>>,
                >,
            >,
        }
        ...
        impl<'a: 'b, 'b> VertexAccessorsBuilder<'a, 'b> {
            ...
            pub fn add_attrs(
                &mut self,
                attrs: flatbuffers::WIPOffset<
                    flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<VertexAccessor<'b>>>,
                >,
            ) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                    VertexAccessors::VT_ATTRS,
                    attrs,
                );
            }
            #[inline]
            pub fn add_size_(
                &mut self,
                size_: flatbuffers::WIPOffset<
                    flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<VertexSize<'b>>>,
                >,
            ) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                    VertexAccessors::VT_SIZE_,
                    size_,
                );
            }
            #[inline]
        ...
        impl VertexAccessorsT {
            pub fn pack<'b>(
                ...
                VertexAccessors::create(_fbb, &VertexAccessorsArgs { attrs, size_ })
            }
        }
        ...
        impl<'a> MaterialInfo<'a> {
            ...
            pub fn poly_count(&self) -> u32 {
                ...
                unsafe {
                    self._tab
                        .get::<u32>(MaterialInfo::VT_POLY_COUNT, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn poly_offset(&self) -> u32 {
                ...
                unsafe {
                    self._tab
                        .get::<u32>(MaterialInfo::VT_POLY_OFFSET, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn sh_unk3(&self) -> u32 {
                ...
                unsafe {
                    self._tab
                        .get::<u32>(MaterialInfo::VT_SH_UNK3, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            ...
            pub fn sh_unk4(&self) -> i32 {
                ...
                unsafe {
                    self._tab
                        .get::<i32>(MaterialInfo::VT_SH_UNK4, Some(-1))
                        .unwrap()
                }
            }
        }
        ...
        impl<'a: 'b, 'b> MaterialInfoBuilder<'a, 'b> {
            ...
            pub fn add_poly_count(&mut self, poly_count: u32) {
                self.fbb_
                    .push_slot::<u32>(MaterialInfo::VT_POLY_COUNT, poly_count, 0);
            }
            #[inline]
            pub fn add_poly_offset(&mut self, poly_offset: u32) {
                self.fbb_
                    .push_slot::<u32>(MaterialInfo::VT_POLY_OFFSET, poly_offset, 0);
            }
            #[inline]
            pub fn add_sh_unk3(&mut self, sh_unk3: u32) {
                self.fbb_
                    .push_slot::<u32>(MaterialInfo::VT_SH_UNK3, sh_unk3, 0);
            }
            #[inline]
            ...
            pub fn add_sh_unk4(&mut self, sh_unk4: i32) {
                self.fbb_
                    .push_slot::<i32>(MaterialInfo::VT_SH_UNK4, sh_unk4, -1);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
            ) -> MaterialInfoBuilder<'a, 'b> {
                let start = _fbb.start_table();
                MaterialInfoBuilder {
                    fbb_: _fbb,
                    start_: start,
        ...
        impl<'a> MorphAccessor<'a> {
            ...
            pub fn unk_0(&self) -> u32 {
                ...
                unsafe {
                    self._tab
                        .get::<u32>(MorphAccessor::VT_UNK_0, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn attribute(&self) -> MorphAttribute {
                ...
                unsafe {
                    self._tab
                        .get::<MorphAttribute>(
                            MorphAccessor::VT_ATTRIBUTE,
                            Some(MorphAttribute::NONE),
                        )
                        .unwrap()
                }
            }
            ...
            pub fn unk_1(&self) -> u32 {
                ...
                unsafe {
                    self._tab
                        .get::<u32>(MorphAccessor::VT_UNK_1, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn type_(&self) -> Type {
                ...
                unsafe {
                    self._tab
                        .get::<Type>(MorphAccessor::VT_TYPE_, Some(Type::NONE))
                        .unwrap()
                }
            }
            #[inline]
            pub fn position(&self) -> u32 {
                ...
                unsafe {
                    self._tab
                        .get::<u32>(MorphAccessor::VT_POSITION, Some(0))
                        .unwrap()
                }
            }
        }
        ...
        impl<'a: 'b, 'b> MorphAccessorBuilder<'a, 'b> {
            ...
            pub fn add_unk_0(&mut self, unk_0: u32) {
                self.fbb_
                    .push_slot::<u32>(MorphAccessor::VT_UNK_0, unk_0, 0);
            }
            #[inline]
            pub fn add_attribute(&mut self, attribute: MorphAttribute) {
                self.fbb_.push_slot::<MorphAttribute>(
                    MorphAccessor::VT_ATTRIBUTE,
                    attribute,
                    MorphAttribute::NONE,
                );
            ...
            pub fn add_unk_1(&mut self, unk_1: u32) {
                self.fbb_
                    .push_slot::<u32>(MorphAccessor::VT_UNK_1, unk_1, 0);
            }
            #[inline]
            pub fn add_type_(&mut self, type_: Type) {
                self.fbb_
                    .push_slot::<Type>(MorphAccessor::VT_TYPE_, type_, Type::NONE);
            }
            #[inline]
            pub fn add_position(&mut self, position: u32) {
                self.fbb_
                    .push_slot::<u32>(MorphAccessor::VT_POSITION, position, 0);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
            ) -> MorphAccessorBuilder<'a, 'b> {
                let start = _fbb.start_table();
        ...
        impl MorphSizeT {
            pub fn pack<'b>(
                ...
                let size_ = self.size_;
                MorphSize::create(_fbb, &MorphSizeArgs { size_ })
            }
        }
        ...
        impl<'a> MorphData<'a> {
            ...
            pub fn unpack(&self) -> MorphDataT {
                let attrs = self.attrs().map(|x| x.iter().map(|t| t.unpack()).collect());
                let size_ = self.size_().map(|x| x.iter().map(|t| t.unpack()).collect());
                MorphDataT { attrs, size_ }
            }

            #[inline]
            pub fn attrs(
                &self,
            ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MorphAccessor<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MorphAccessor>>,
                    >>(MorphData::VT_ATTRS, None)
                }
            }
            #[inline]
            pub fn size_(
                &self,
            ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MorphSize<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MorphSize>>,
                    >>(MorphData::VT_SIZE_, None)
                }
            }
        }
        ...
        impl flatbuffers::Verifiable for MorphData<'_> {
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    .visit_field::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<MorphAccessor>>,
                    >>("attrs", Self::VT_ATTRS, false)?
                    .visit_field::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<MorphSize>>,
                    >>("size_", Self::VT_SIZE_, false)?
                    .finish();
                Ok(())
            }
        ...
        pub struct MorphDataArgs<'a> {
            pub attrs: Option<
                flatbuffers::WIPOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MorphAccessor<'a>>>,
                >,
            >,
            pub size_: Option<
                flatbuffers::WIPOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MorphSize<'a>>>,
                >,
            >,
        }
        ...
        impl<'a: 'b, 'b> MorphDataBuilder<'a, 'b> {
            ...
            pub fn add_attrs(
                &mut self,
                attrs: flatbuffers::WIPOffset<
                    flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<MorphAccessor<'b>>>,
                >,
            ) {
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<_>>(MorphData::VT_ATTRS, attrs);
            }
            #[inline]
            pub fn add_size_(
                &mut self,
                size_: flatbuffers::WIPOffset<
                    flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<MorphSize<'b>>>,
                >,
            ) {
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<_>>(MorphData::VT_SIZE_, size_);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
            ) -> MorphDataBuilder<'a, 'b> {
                let start = _fbb.start_table();
                MorphDataBuilder {
                    fbb_: _fbb,
                    start_: start,
        ...
        impl MorphDataT {
            pub fn pack<'b>(
                ...
                MorphData::create(_fbb, &MorphDataArgs { attrs, size_ })
            }
        }
        ...
        impl<'a> MorphMetaData<'a> {
            ...
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                ...
                if let Some(x) = args.morph_name {
                    builder.add_morph_name(x);
                }
            ...
            pub fn unpack(&self) -> MorphMetaDataT {
                ...
                let morph_name = self.morph_name().map(|x| x.to_string());
            ...
            pub fn morph_index(&self) -> u32 {
                ...
                unsafe {
                    self._tab
                        .get::<u32>(MorphMetaData::VT_MORPH_INDEX, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            ...
            pub fn morph_type(&self) -> u8 {
                ...
                unsafe {
                    self._tab
                        .get::<u8>(MorphMetaData::VT_MORPH_TYPE, Some(0))
                        .unwrap()
                }
            }
        }
        ...
        impl<'a: 'b, 'b> MorphMetaDataBuilder<'a, 'b> {
            ...
            pub fn add_morph_index(&mut self, morph_index: u32) {
                self.fbb_
                    .push_slot::<u32>(MorphMetaData::VT_MORPH_INDEX, morph_index, 0);
            }
            #[inline]
            ...
            pub fn add_morph_type(&mut self, morph_type: u8) {
                self.fbb_
                    .push_slot::<u8>(MorphMetaData::VT_MORPH_TYPE, morph_type, 0);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
            ) -> MorphMetaDataBuilder<'a, 'b> {
                let start = _fbb.start_table();
        ...
        impl MorphMetaDataT {
            pub fn pack<'b>(
                ...
                let morph_index = self.morph_index;
                let morph_name = self.morph_name.as_ref().map(|x| _fbb.create_string(x));
                let morph_type = self.morph_type;
                MorphMetaData::create(
                    _fbb,
                    &MorphMetaDataArgs {
                        morph_index,
                        morph_name,
        ...
        impl<'a> MorphShape<'a> {
            ...
            pub fn data(
                &self,
            ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MorphData<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MorphData>>,
                    >>(MorphShape::VT_DATA, None)
                }
            }
            #[inline]
            pub fn metadata(
                &self,
            ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MorphMetaData<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MorphMetaData>>,
                    >>(MorphShape::VT_METADATA, None)
                }
            }
            #[inline]
            pub fn morph_name(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<flatbuffers::ForwardsUOffset<&str>>(MorphShape::VT_MORPH_NAME, None)
                }
            }
        }
        ...
        impl flatbuffers::Verifiable for MorphShape<'_> {
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    .visit_field::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<MorphData>>,
                    >>("data", Self::VT_DATA, false)?
                    .visit_field::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<MorphMetaData>>,
        ...
        pub struct MorphShapeArgs<'a> {
            pub data: Option<
                flatbuffers::WIPOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MorphData<'a>>>,
                >,
            >,
            pub metadata: Option<
                flatbuffers::WIPOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MorphMetaData<'a>>>,
                >,
            >,
            pub morph_name: Option<flatbuffers::WIPOffset<&'a str>>,
        }
        ...
        impl<'a: 'b, 'b> MorphShapeBuilder<'a, 'b> {
            ...
            pub fn add_data(
                ...
                data: flatbuffers::WIPOffset<
                    flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<MorphData<'b>>>,
                >,
            ) {
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<_>>(MorphShape::VT_DATA, data);
            }
            #[inline]
            pub fn add_metadata(
                &mut self,
                metadata: flatbuffers::WIPOffset<
                    flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<MorphMetaData<'b>>>,
                >,
            ) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                    MorphShape::VT_METADATA,
                    metadata,
                );
            }
            #[inline]
        ...
        impl<'a> VisShape<'a> {
            ...
            pub fn name(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<flatbuffers::ForwardsUOffset<&str>>(VisShape::VT_NAME, None)
                }
            }
        }
        ...
        impl<'a: 'b, 'b> VisShapeBuilder<'a, 'b> {
            ...
            pub fn add_name(&mut self, name: flatbuffers::WIPOffset<&'b str>) {
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<_>>(VisShape::VT_NAME, name);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
        ...
        impl VisShapeT {
            pub fn pack<'b>(
                ...
                VisShape::create(_fbb, &VisShapeArgs { index, name })
            }
        }
        ...
        impl<'a> MeshShape<'a> {
            ...
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                ...
                if let Some(x) = args.morph_shape {
                    builder.add_morph_shape(x);
                }
                builder.add_unk13(args.unk13);
                if let Some(x) = args.mesh_name {
                    builder.add_mesh_name(x);
                }
                if let Some(x) = args.vis_shapes {
                    builder.add_vis_shapes(x);
                }
                if let Some(x) = args.influence {
                    builder.add_influence(x);
                }
                if let Some(x) = args.clip_sphere {
                    builder.add_clip_sphere(x);
                }
                ...
                if let Some(x) = args.mesh_shape_name {
                    builder.add_mesh_shape_name(x);
                }
                builder.finish()
            }

            pub fn unpack(&self) -> MeshShapeT {
                let mesh_shape_name = self.mesh_shape_name().map(|x| x.to_string());
                ...
                let res2 = self.res2();
                let res3 = self.res3();
                let clip_sphere = self.clip_sphere().map(|x| x.unpack());
                let influence = self
                    .influence()
                    .map(|x| x.iter().map(|t| t.unpack()).collect());
                let vis_shapes = self
            ...
            pub fn bounds(&self) -> Option<BoundingBox<'a>> {
                ...
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<flatbuffers::ForwardsUOffset<BoundingBox>>(
                        MeshShape::VT_BOUNDS,
                        None,
                    )
                }
            ...
            pub fn polygon_type(&self) -> PolygonType {
                ...
                unsafe {
                    self._tab
                        .get::<PolygonType>(
                            MeshShape::VT_POLYGON_TYPE,
                            Some(PolygonType::X8_Y8_Z8_UNSIGNED),
                        )
                        .unwrap()
                }
            }
            ...
            pub fn attributes(
                &self,
            ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<VertexAccessors<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<VertexAccessors>>,
                    >>(MeshShape::VT_ATTRIBUTES, None)
                }
            }
            #[inline]
            pub fn materials(
                &self,
            ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MaterialInfo<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MaterialInfo>>,
                    >>(MeshShape::VT_MATERIALS, None)
                }
            }
            #[inline]
            ...
            pub fn influence(
                &self,
            ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Influence<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Influence>>,
                    >>(MeshShape::VT_INFLUENCE, None)
                }
            }
            #[inline]
            pub fn vis_shapes(
                &self,
            ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<VisShape<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<VisShape>>,
                    >>(MeshShape::VT_VIS_SHAPES, None)
                }
            }
            #[inline]
            pub fn mesh_name(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<flatbuffers::ForwardsUOffset<&str>>(MeshShape::VT_MESH_NAME, None)
                }
            }
            #[inline]
            ...
            pub fn morph_shape(
                &self,
            ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MorphShape<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MorphShape>>,
                    >>(MeshShape::VT_MORPH_SHAPE, None)
                }
            }
        }
        ...
        impl flatbuffers::Verifiable for MeshShape<'_> {
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                        "mesh_shape_name",
                        Self::VT_MESH_SHAPE_NAME,
                        false,
                    )?
                    .visit_field::<flatbuffers::ForwardsUOffset<BoundingBox>>(
                        "bounds",
                        Self::VT_BOUNDS,
                        false,
                    )?
                    ...
                    .visit_field::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<VertexAccessors>>,
                    >>("attributes", Self::VT_ATTRIBUTES, false)?
                    .visit_field::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<MaterialInfo>>,
                    ...
                    .visit_field::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Influence>>,
                    >>("influence", Self::VT_INFLUENCE, false)?
                    .visit_field::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<VisShape>>,
                    >>("vis_shapes", Self::VT_VIS_SHAPES, false)?
                    .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                        "mesh_name",
                        Self::VT_MESH_NAME,
                        false,
                    ...
                    .visit_field::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<MorphShape>>,
                    >>("morph_shape", Self::VT_MORPH_SHAPE, false)?
                    .finish();
                Ok(())
            }
        }
        pub struct MeshShapeArgs<'a> {
            ...
            pub attributes: Option<
                flatbuffers::WIPOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<VertexAccessors<'a>>>,
                >,
            >,
            pub materials: Option<
                flatbuffers::WIPOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MaterialInfo<'a>>>,
                >,
            >,
            pub res0: u32,
            pub res1: u32,
            ...
            pub influence: Option<
                flatbuffers::WIPOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Influence<'a>>>,
                >,
            >,
            pub vis_shapes: Option<
                flatbuffers::WIPOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<VisShape<'a>>>,
                >,
            >,
            pub mesh_name: Option<flatbuffers::WIPOffset<&'a str>>,
            pub unk13: u32,
            pub morph_shape: Option<
                flatbuffers::WIPOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MorphShape<'a>>>,
                >,
            >,
        }
        ...
        impl<'a: 'b, 'b> MeshShapeBuilder<'a, 'b> {
            #[inline]
            pub fn add_mesh_shape_name(
                &mut self,
                mesh_shape_name: flatbuffers::WIPOffset<&'b str>,
            ) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                    MeshShape::VT_MESH_SHAPE_NAME,
                    mesh_shape_name,
            ...
            pub fn add_bounds(&mut self, bounds: flatbuffers::WIPOffset<BoundingBox<'b>>) {
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<BoundingBox>>(
                        MeshShape::VT_BOUNDS,
                        bounds,
                    );
            }
            ...
            pub fn add_polygon_type(&mut self, polygon_type: PolygonType) {
                self.fbb_.push_slot::<PolygonType>(
                    MeshShape::VT_POLYGON_TYPE,
                    polygon_type,
                    PolygonType::X8_Y8_Z8_UNSIGNED,
                );
            ...
            pub fn add_attributes(
                ...
                attributes: flatbuffers::WIPOffset<
                    flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<VertexAccessors<'b>>>,
                >,
            ) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                    MeshShape::VT_ATTRIBUTES,
                    attributes,
                );
            }
            #[inline]
            pub fn add_materials(
                ...
                materials: flatbuffers::WIPOffset<
                    flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<MaterialInfo<'b>>>,
                >,
            ) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                    MeshShape::VT_MATERIALS,
                    materials,
                );
            }
            #[inline]
            ...
            pub fn add_clip_sphere(&mut self, clip_sphere: &Sphere) {
                self.fbb_
                    .push_slot_always::<&Sphere>(MeshShape::VT_CLIP_SPHERE, clip_sphere);
            }
            #[inline]
            pub fn add_influence(
                &mut self,
                influence: flatbuffers::WIPOffset<
                    flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<Influence<'b>>>,
                >,
            ) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                    MeshShape::VT_INFLUENCE,
                    influence,
                );
            }
            #[inline]
            pub fn add_vis_shapes(
                &mut self,
                vis_shapes: flatbuffers::WIPOffset<
                    flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<VisShape<'b>>>,
                >,
            ) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                    MeshShape::VT_VIS_SHAPES,
                    vis_shapes,
                );
            }
            #[inline]
            ...
            #[inline]
            pub fn add_morph_shape(
                &mut self,
                morph_shape: flatbuffers::WIPOffset<
                    flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<MorphShape<'b>>>,
                >,
            ) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                    MeshShape::VT_MORPH_SHAPE,
                    morph_shape,
                );
            }
            #[inline]
        ...
        impl MeshShapeT {
            pub fn pack<'b>(
                ...
                let mesh_shape_name = self.mesh_shape_name.as_ref().map(|x| _fbb.create_string(x));
        ...
        impl<'a> TRMSH<'a> {
            ...
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                ...
                if let Some(x) = args.buffer_name {
                    builder.add_buffer_name(x);
                }
            ...
            pub fn unpack(&self) -> TRMSHT {
                ...
                let meshes = self
                    .meshes()
                    .map(|x| x.iter().map(|t| t.unpack()).collect());
                let buffer_name = self.buffer_name().map(|x| x.to_string());
                TRMSHT {
                    unk0,
                    meshes,
                    buffer_name,
            ...
            pub fn meshes(
                &self,
            ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MeshShape<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MeshShape>>,
                    >>(TRMSH::VT_MESHES, None)
                }
            }
            #[inline]
            pub fn buffer_name(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<flatbuffers::ForwardsUOffset<&str>>(TRMSH::VT_BUFFER_NAME, None)
                }
            }
        }
        ...
        impl flatbuffers::Verifiable for TRMSH<'_> {
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    ...
                    .visit_field::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<MeshShape>>,
        ...
        pub struct TRMSHArgs<'a> {
            ...
            pub meshes: Option<
                flatbuffers::WIPOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MeshShape<'a>>>,
                >,
            >,
        ...
        impl<'a: 'b, 'b> TRMSHBuilder<'a, 'b> {
            ...
            pub fn add_meshes(
                ...
                meshes: flatbuffers::WIPOffset<
                    flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<MeshShape<'b>>>,
                >,
            ) {
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<_>>(TRMSH::VT_MESHES, meshes);
            }
            #[inline]
            pub fn add_buffer_name(&mut self, buffer_name: flatbuffers::WIPOffset<&'b str>) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                    TRMSH::VT_BUFFER_NAME,
                    buffer_name,
                );
            }
            #[inline]
        ...
        impl TRMSHT {
            pub fn pack<'b>(
                ...
                let buffer_name = self.buffer_name.as_ref().map(|x| _fbb.create_string(x));
                TRMSH::create(
                    _fbb,
                    &TRMSHArgs {
                        unk0,
        ...
        pub fn size_prefixed_root_as_trmsh(
            buf: &[u8],
        ) -> Result<TRMSH, flatbuffers::InvalidFlatbuffer> {
        ...
        #[inline]
        pub fn finish_size_prefixed_trmsh_buffer<'a, 'b>(
            fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
            root: flatbuffers::WIPOffset<TRMSH<'a>>,
        ) {
