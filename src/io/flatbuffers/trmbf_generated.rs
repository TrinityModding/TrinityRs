...
impl<'a> Indexes<'a> {
  ...
  pub fn buffer(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Indexes::VT_BUFFER, None)}
  }
}
...
impl<'a: 'b, 'b> IndexesBuilder<'a, 'b> {
  ...
  pub fn add_buffer(&mut self, buffer: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Indexes::VT_BUFFER, buffer);
  }
  #[inline]
...
impl IndexesT {
  pub fn pack<'b>(
    ...
    let buffer = self.buffer.as_ref().map(|x|{
      _fbb.create_vector(x)
    });
    Indexes::create(_fbb, &IndexesArgs{
      buffer,
    })
  }
}
...
impl<'a> Vertices<'a> {
  ...
  pub fn buffer(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Vertices::VT_BUFFER, None)}
  }
}
...
impl<'a: 'b, 'b> VerticesBuilder<'a, 'b> {
  #[inline]
  pub fn add_buffer(&mut self, buffer: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Vertices::VT_BUFFER, buffer);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> VerticesBuilder<'a, 'b> {
    let start = _fbb.start_table();
    VerticesBuilder {
      fbb_: _fbb,
      start_: start,
...
impl VerticesT {
  pub fn pack<'b>(
    ...
    Vertices::create(_fbb, &VerticesArgs{
      buffer,
    })
  }
}
...
impl<'a> MorphBuffer<'a> {
  ...
  pub fn buffer(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(MorphBuffer::VT_BUFFER, None)}
  }
}
...
impl<'a: 'b, 'b> MorphBufferBuilder<'a, 'b> {
  #[inline]
  pub fn add_buffer(&mut self, buffer: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MorphBuffer::VT_BUFFER, buffer);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> MorphBufferBuilder<'a, 'b> {
    let start = _fbb.start_table();
    MorphBufferBuilder {
      fbb_: _fbb,
      start_: start,
...
impl MorphBufferT {
  pub fn pack<'b>(
    ...
    MorphBuffer::create(_fbb, &MorphBufferArgs{
      buffer,
    })
  }
}
...
impl<'a> Morphs<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    if let Some(x) = args.morph_buffer { builder.add_morph_buffer(x); }
    builder.finish()
  }

  pub fn unpack(&self) -> MorphsT {
    let morph_buffer = self.morph_buffer().map(|x| {
  ...
  #[inline]
  pub fn morph_buffer(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MorphBuffer<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MorphBuffer>>>>(Morphs::VT_MORPH_BUFFER, None)}
  }
}
...
impl flatbuffers::Verifiable for Morphs<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<MorphBuffer>>>>("morph_buffer", Self::VT_MORPH_BUFFER, false)?
     .finish();
    Ok(())
  }
}
pub struct MorphsArgs<'a> {
    pub morph_buffer: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MorphBuffer<'a>>>>>,
}
...
impl<'a: 'b, 'b> MorphsBuilder<'a, 'b> {
  #[inline]
  pub fn add_morph_buffer(&mut self, morph_buffer: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<MorphBuffer<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Morphs::VT_MORPH_BUFFER, morph_buffer);
  }
  #[inline]
...
impl<'a> Buffer<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    if let Some(x) = args.morphs { builder.add_morphs(x); }
    if let Some(x) = args.vertex_buffer { builder.add_vertex_buffer(x); }
    if let Some(x) = args.index_buffer { builder.add_index_buffer(x); }
    builder.finish()
  }

  pub fn unpack(&self) -> BufferT {
    let index_buffer = self.index_buffer().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let vertex_buffer = self.vertex_buffer().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let morphs = self.morphs().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    BufferT {
      index_buffer,
  ...
  #[inline]
  pub fn index_buffer(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Indexes<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Indexes>>>>(Buffer::VT_INDEX_BUFFER, None)}
  }
  #[inline]
  pub fn vertex_buffer(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Vertices<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Vertices>>>>(Buffer::VT_VERTEX_BUFFER, None)}
  }
  #[inline]
  pub fn morphs(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Morphs<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Morphs>>>>(Buffer::VT_MORPHS, None)}
  }
}
...
impl flatbuffers::Verifiable for Buffer<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Indexes>>>>("index_buffer", Self::VT_INDEX_BUFFER, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Vertices>>>>("vertex_buffer", Self::VT_VERTEX_BUFFER, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Morphs>>>>("morphs", Self::VT_MORPHS, false)?
     .finish();
    Ok(())
  }
}
pub struct BufferArgs<'a> {
    pub index_buffer: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Indexes<'a>>>>>,
    pub vertex_buffer: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Vertices<'a>>>>>,
    pub morphs: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Morphs<'a>>>>>,
}
...
impl<'a: 'b, 'b> BufferBuilder<'a, 'b> {
  #[inline]
  pub fn add_index_buffer(&mut self, index_buffer: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Indexes<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Buffer::VT_INDEX_BUFFER, index_buffer);
  }
  #[inline]
  pub fn add_vertex_buffer(&mut self, vertex_buffer: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Vertices<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Buffer::VT_VERTEX_BUFFER, vertex_buffer);
  }
  #[inline]
  pub fn add_morphs(&mut self, morphs: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Morphs<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Buffer::VT_MORPHS, morphs);
  }
  #[inline]
...
impl<'a> TRMBF<'a> {
  ...
  pub fn buffers(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Buffer<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Buffer>>>>(TRMBF::VT_BUFFERS, None)}
  }
}
...
impl<'a: 'b, 'b> TRMBFBuilder<'a, 'b> {
  ...
  pub fn add_buffers(&mut self, buffers: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Buffer<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(TRMBF::VT_BUFFERS, buffers);
  }
  #[inline]
...
pub fn size_prefixed_root_as_trmbf(buf: &[u8]) -> Result<TRMBF, flatbuffers::InvalidFlatbuffer> {
...
#[inline]
pub fn finish_size_prefixed_trmbf_buffer<'a, 'b>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>, root: flatbuffers::WIPOffset<TRMBF<'a>>) {
